...
Often, the verb itself is implicit in the \isi{purpose} \isi{clause}, and instead the \isi{direct object} argument, \textit{looṛíia} `bowls' in (\ref{ex:13-83}), receives the dative marking.
...
Causality (perhaps internal in particular) can also be expressed in a~more explicit way, for instance as in (\ref{ex:13-92}), through a~relativisation of \textit{wáǰa} `reason', a~\isi{noun} borrowed from \iliPashto, or a~dependent \isi{clause} with a~\isi{Verbal Noun} and a~\isi{postposition}, the latter exemplified in (\ref{ex:13-93}).
