...
The \isi{adjective} head can also itself be modified, usually by a~scalar \isi{quantifier}, such as \textit{bíiḍu} modifying \textit{mhoóru} and \textit{šišáwu} in (\ref{ex:10-6}), assuming that the \isi{noun} can have more or less of the quality implied by the modifying \isi{adjective} \isi{phrase}. 
...
whenever they occur in the same \isi{noun} \isi{phrase}: \isi{adjective} phrases, as in (\ref{ex:10-37}), quantifiers, as in (\ref{ex:10-38}), \isi{indefinite} determiners, as in (\ref{ex:10-39}), and \isi{definite} determiners, as in
(\ref{ex:10-40}).
