...
\ChapterDOI{10.5281/zenodo.14224259}
...
% % % \chapter{Translation of Adjarian 1899 on voice onset time}

\abstract{Below is a translation \textit{Les Explosives de l'ancien arménien étudiées dans les dialectes modernes} \citep{Adjarian-1899-ArmenianExplosives}, done by George Balabanian. That paper is an early acoustic demonstration of voice onset time, using Armenian data \citep{braun-2013-earlyCaseVOTAdjarian}.} 
...
\begin{figure}
	\includegraphics[width=.9\textwidth]{images/adjarian1899fig1.jpg}
	\caption{Original figure 1 for reflexes of Classical Armenian voiced stops and affricates}
	\label{fig:fig1 original}
\end{figure}

\begin{figure}
	\includegraphics[width=.9\textwidth]{images/adjarian1899fig2.jpg}
...
\begin{figure}
	\includegraphics[width=.9\textwidth]{images/adjarian1899fig3.jpg}
...
\begin{figure}
	\includegraphics[width=.9\textwidth]{images/adjarian1899fig4.jpg}
...
The sounds \armenian{բ, գ, դ, ձ, ջ} – /b, ɡ, d,  d͡z,  d͡ʒ/  as shown in Figures~\ref{fig:fig1 original} and \ref{fig:fig2 original}. 
...
The sounds \armenian{պ, կ, տ, ծ, ճ} – /p,  k,  t, t͡s,  t͡ʃ/ in Figure \ref{fig:fig3 original}. 
...
The sounds \armenian{փ, ք, թ, ց, չ} –  pʰ, kʰ, tʰ,  t͡sʰ,  t͡ʃʰ in Figure \ref{fig:fig4 original}.
