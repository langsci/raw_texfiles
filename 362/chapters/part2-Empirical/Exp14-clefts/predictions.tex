...
\lsptoprule
 ...
 &
  ...
  \multicolumn{2}{c}{{no-island accounts}} \\ \cline{2-6} 
 &
...
\multicolumn{1}{l}{{\begin{tabular}[c]{@{}l@{}}extractions vs. \\ non-extractions\end{tabular}}} &
  ...
  \begin{tabular}[c]{@{}l@{}}main effect of extraction\\ + interaction effect \\ such that (a) \textless (b,c,d)\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}main effect of extraction\\ + interaction effect \\ such that (a) \textless (b,c,d)\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}main effect of function\\ (subj > obj) \\ + no interaction effect\end{tabular} &
...
\caption{Predictions of the different accounts for Experiment 14 (clefts). \emph{Notes}: (a) Condition subject + PP-extracted (b) Condition object + PP-extracted (c) Condition subject + whole NP extracted (d) Condition object + whole NP extracted (e) Condition subject + ungrammatical (f) Condition object + ungrammatical.}
\label{tab:exp14-predictions}
\end{sidewaystable}
