...
#
	sed -i 's/American English/English!American English/' main.ldx
	sed -i 's/British English/English!British English/' main.ldx
	sed -i 's/Chicago English/English!Chicago English/' main.ldx
	sed -i 's/Middle English/English!Middle English/' main.ldx
	sed -i 's/Old English/English!Old English/' main.ldx
	sed -i 's/Mandarin Chinese/Chinese!Mandarin/' main.ldx
	sed -i 's/Szechuan Chinese/Chinese!Szechuan Chinese/' main.ldx
#
	sed -i 's/signifiants/signifiant/' main.sdx
	sed -i 's/signifiés/signifié/' main.sdx
	sed -i 's/alternations/alternation/' main.sdx
	sed -i 's/anthropophonics/anthropophonic/' main.sdx
	sed -i 's/nasal consonants/nasal consonant/' main.sdx
	sed -i 's/nasal vowels/nasal vowel/' main.sdx
	sed -i 's/psychophonetics/psychophonetic/' main.sdx
	sed -i 's/syllables/syllable/' main.sdx
	sed -i 's/vowels/vowel/' main.sdx
	sed -i 's/significant//' main.sdx
	sed -i 's/feature geometry/Feature Geometry/' main.sdx
	sed -i 's/generative grammar/Generative Grammar/' main.sdx
	sed -i 's/{BAE|//' main.sdx
	sed -i 's/{Slavic|//' main.sdx
	sed -i 's/{change|//' main.sdx
	sed -i 's/{consonants|//' main.sdx
	sed -i 's/{linguistic system|//' main.sdx
	sed -i 's/{phonetic|//' main.sdx
	sed -i 's/{regular|//' main.sdx
	sed -i 's/{regularities|//' main.sdx
	sed -i 's/{representations|//' main.sdx
	sed -i 's/{sound structure|//' main.sdx
	sed -i 's/{vowels|//' main.sdx
# 	python3 fixindex.py
# 	mv mainmod.adx main.adx
# 	makeindex -o main.and main.adx
	cp main.and.anderson main.and
