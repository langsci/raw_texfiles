...
main.snd:  FORCE
	...
	sed -i 's/Allemand/allemand/' main.ldx
	sed -i 's/Italien/italien/' main.ldx
	sed -i 's/Russe/russe/' main.ldx
	sed -i 's/Persan/persan/' main.ldx
	sed -i 's/Basque/basque/' main.ldx
	sed -i 's/Dargwa/dargwa/' main.ldx
	sed -i 's/Gaélique irlandais/gaélique irlandais/' main.ldx
	sed -i 's/Japonais/japonais/' main.ldx 
	sed -i 's/Portugais/portugais/' main.ldx
	sed -i 's/Turc/turc/' main.ldx
