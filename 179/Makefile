...
main.snd: main.bbl
	...
	sed -i 's/.*Archive.*//' main.adx
	sed -i 's/.*RHS.*//' main.adx
	sed -i 's/.*VCDH.*//' main.adx
	sed -i 's/.*Britain.*//' main.adx
	sed -i 's/.*IEAHC.*//' main.adx
	sed -i 's/hyperindexformat{\\\(infn {[0-9]*\)}//' main.ldx
	python3 fixindex.py
