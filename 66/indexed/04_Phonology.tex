...
/u/&\emph{uma}  \rede{enter}&\emph{mẽ.u.le}  \rede{without entering}\\
/lap/&\emph{lapma} \rede{seize, catch}&\emph{mẽ.lap.le}   \rede{without catching}\\
/yok/&\emph{yokma} \rede{search}&\emph{mẽ.yok.le}  \rede{without searching}\\
\lspbottomrule
\end{tabular}
