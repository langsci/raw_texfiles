...
\textsc{a} \> (in possessives:) \textit{a}{}-class \isi{possession}\\
A \> (verb argument:) the most \isi{agentive} argument of a transitive verb\\
A/M \> \isi{aspect}/mood marker\\
{\scshape acc} \> accusative (\textit{i})\\
{\scshape ag} \> \isi{agentive} (\textit{e})\\
{\scshape ana} \> general anaphor (\textit{ira})\\
{\scshape art} \> article (\textit{te})\\
{\scshape ben} \> benefactive\\
{\scshape C} \> consonant\\
{\scshape caus} \> {\isi{causative} (\textit{haka})}\\
...
{\scshape cq} \> \isi{content question} (\textit{hē})\\
...
{\scshape imp} \> {\isi{imperative} (\textit{ka})}\\
{\scshape incl} \> inclusive\\
{\scshape ins} \> instrumental (\textit{hai})\\
{\scshape intens} \> intensifier (\textit{rā})\\
{\scshape ipfv} \> \isi{imperfective} (\textit{e})\\
{\scshape irr} \> irrealis (\textit{ana})\\
LOC \> locative; locational\\
{\scshape med} \> medial distance\\
N \> noun\\
{\scshape neg} \> \isi{negation} (\textit{{\ꞌ}ina})\\
{\scshape conneg} \> constituent \isi{negation} (\textit{ta{\ꞌ}e})\\
{\scshape nmlz} \> nominaliser\\
{\scshape ntr} \> neutral \isi{aspect} (\textit{he})\\
{\scshape num} \> numeral marker\\
{\scshape num.pers} \> personal numeral marker (\textit{hoko})\\
\textsc{o} \> (in possessives:) \textit{o}{}-class \isi{possession}\\
O \> (verb argument:) the least \isi{agentive} argument of a transitive verb\\
{\scshape past} \> past\\
{\scshape pfv} \> perfective (\textit{i})\\
{\scshape pl} \> plural\\
PND \> {postnominal demonstrative}\\
{\scshape poss} \> possessive\\
{\scshape pq} \> \isi{polar question} (\textit{hoki})\\
...
{\scshape pvp} \> postverbal \isi{particle} (\textit{ai})\\
QTF \> \isi{quantifier}\\
{\scshape red} \> \isi{reduplication}\\
S \> the single argument of an \isi{intransitive} verb\\
{\scshape sg} \> singular\\
%\lspbottomrule
%\end{tabularx}
%\begin{tabularx}{\textwidth}{L{15mm}X}
