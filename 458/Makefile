...
main.snd: main.bbl
	...
	sed -i 's/.*BTh.*//' main.adx
	sed -i 's/.*DU1701.*//' main.adx
	sed -i 's/.*HTOED.*//' main.adx
	sed -i 's/.*LexP.*//' main.adx
	sed -i 's/.*Académie.*//' main.adx
	sed -i 's/.*Accademia*//' main.adx
	sed -i 's/.*Anonymous.*//' main.adx
