...
% For the second edition: the 'hack' does not work anymore... and furthermore the typography with a line break appears OK, in line with the project of a grammar book that has the language name on the 2nd line.
% \A grammar of \\ Yongning Na
...
% Alexis: code for Pangloss DOIs (taken up from LangSci#295: \textit{A grammar of Japhug}): 
\newcommand{\pandoi}[1]{{\color{gray}\{\href{https://doi.org/10.24397/pangloss-#1}{#1}\}}}

% Alexis: code formerly embedded in line 1554 of 03.tex (in the 1st edition), now proudly promoted to a position within localcommands.tex, for application throughout the document.
