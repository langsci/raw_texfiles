...
\is{pitch accent| see {tonal accent}}
...
\ilsa{rGyalrongic}{Zhuokeji rGyalrong}
\ilsa{Nosu}{Yi}
\ilsa{Yi}{Nosu}
...
\ilsa{Austroasiatic}{Mon-Khmer}
\ilsa{Mon-Khmer}{Austroasiatic}

% Subjects
\issa{exceptions}{irregularities}
\issa{irregularities}{exceptions}
\issa{object}{cognate object}
