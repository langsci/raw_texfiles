...
The content of this book is based on some parts of my unpublished doctoral  thesis  \citep{brin11} and recent publications. While the dissertation's  appendix was expanded to make up the dictionary and the  reversal index offered in the first two parts of this book, the grammatical outline has been condensed and improved to make up the phonology and grammar sections presented in the third part.  Although the grammar is written with an academic audience in mind, an audience interested in  \ili{Grusi} linguistic topics, it does not presuppose any knowledge of any particular linguistic theory.  It should neither be compared to comprehensive grammars,  as many aspects are not thoroughly covered,  nor to  pedagogical grammars, as it does not propose any prescriptive standards or exercises. Therefore the grammar lies beyond the scope of a typical dictionary grammar. To  publish the data  while time and funds were still available and Chakali is still relatively vibrant was felt most  imperative.
