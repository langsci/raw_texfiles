...
\ChapterDOI{10.5281/zenodo.8427867}
...
The tree in \figref{lasz:fig:1} illustrates our assumptions about the phrase
...
\ea 
    ...
    \footnote{%
        ...
        \begin{exe} \ex[*]{{BOOK}, {FATHER} {MOTHER} {GIVE}\laszDir{a}{b}.} \end{exe}
...
\citet{Matsuoka.1997} proposes the derivation in \figref{lasz:fig:2}. In a verb-doubling
...
other verbal projections below CP are also right-headed (\figref{lasz:fig:3a} vs.~\figref{lasz:fig:3d}
for $Y=\text{C}$). If VP is right-headed, this does not make a statement about
the headedness of the next higher verbal projection (\figref{lasz:fig:3a} vs.~\figref{lasz:fig:3c} for
...
violate~\REF{lasz:ex:29} (\figref{lasz:fig:3b} vs.~\figref{lasz:fig:3d} for $X=\text{V}$). If CP is left-headed, any
headedness is possible for the next lower verbal projection (\figref{lasz:fig:3b}
...
(\figref{lasz:fig:3d} for $X=\text{V}$ and $Y=\text{Asp}$).
...
\end{figure}
\footnotetext{%
    The FOFC is unintuitively named, as the configuration Final-over-final in \figref{lasz:fig:3a} does not stand out in the paradigm. 
