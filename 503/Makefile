main.snd:
	...
	sed -i 's/.*\(Office\|Team\|Bureau\|Organisation\|Organization\|Embassy\|Association\|Commission\|committee\|government\|Agency\|Statistic\).*//' main.adx
	sed -i 's/.*Team.*//' main.adx
	sed -i 's/.*Stofnun.*//' main.adx
