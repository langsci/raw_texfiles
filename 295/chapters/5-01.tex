...
lnk \textsc{3du} bird \textsc{du} boat \textsc{3sg}.\textsc{poss}-on \textsc{aor}:\textsc{east}-go[II]-\textsc{du} \textsc{sens}-be \\
...
\gll a-tɕɯ, ji-rɣa ra nɯ-mbala kɯ tʰa-nɯ-tsɯm tɕe nɯnɯ ɯ-kɯ-ɕar ɕe-tɕi \\
\textsc{1sg}.\textsc{poss}-son \textsc{1pl}.\textsc{poss}-neighbour \textsc{pl} \textsc{3pl}.\textsc{poss}-ox \textsc{erg} \textsc{aor}:3\flobv{}-\textsc{auto}-take.away \textsc{lnk} \textsc{dem} \textsc{3sg}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-search go:\textsc{fact}-\textsc{1du} \\
...
\textsc{2pl}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-herd \textsc{ipfv}:\textsc{upstream}-go-\textsc{1sg} \textsc{qu}-\textsc{sens}-be.good \textsc{irr}-\textsc{pfv}-2-say be.needed:\textsc{fact}  \textsc{sbj}:\textsc{pcp}-be.big \textsc{du} \textsc{3du}.\textsc{poss}-\textsc{dat} say:\textsc{fact} \textsc{sens}-be\\
...
\textsc{3sg}.\textsc{poss}-companion \textsc{ipfv}-search \textsc{sens}-think[III] \textsc{lnk} \textsc{lnk} \textsc{dem} \textsc{inf}:\textsc{stat}-be.like \textsc{ipfv}:\textsc{east}-go \textsc{add} \textsc{ipfv}:west-come \\
...
Cogtse \textsc{aor}:\textsc{east}-go[II]-\textsc{1pl} \textsc{sbj}:\textsc{pcp}-watch \\
...
water.monster \textsc{dem} still completely \textsc{emph} \textsc{ifr}.\textsc{ipfv}-\textsc{auto}-sleep be.\textsc{aff}:\textsc{fact} \textsc{lnk} \\
...
please \textsc{add} please \textsc{prohib}-\textsc{imp}-2$\to$1-eat-\textsc{1sg} always \textsc{ifr}-say \textsc{sens}-be \\
...
everywhere \textsc{emph} house \textsc{pl} \textsc{ipfv}-litter \textsc{indef}.\textsc{poss}-field \textsc{3sg}.\textsc{poss}-inside \textsc{pl} \textsc{ipfv}-litter \\
...
\is{restrictive!adverb}
 The adverb  \japhug{ʁɟa}{completely}, which can be used to mark restrictive focus on a noun phrase (§\ref{sec:restrictive.focus}), also occurs with scope over the whole sentence in the meaning `all, only, always' as in (\ref{ex:kW.RJa.Zo}), where it follows the ergative \forme{kɯ} (compare with \ref{ex:RJa.kW} in §\ref{sec:restrictive.focus}, where the ergative is located after \forme{ʁɟa}).
...
\begin{exe}
	...
	\textsc{2sg}.\textsc{poss}-together \textsc{ipfv}:\textsc{up}-come-\textsc{1sg} be.needed:\textsc{fact} \textsc{lnk} here \textsc{1sg}-alone \textsc{ipfv}-stay-\textsc{1sg} \textsc{neg}:\textsc{sens}-can-\textsc{1sg} \\
...
\textsc{lnk} \textsc{inf}-\textsc{recip}-meet also \textsc{pst}.\textsc{ipfv}-not.exist \textsc{lnk}  transportation completely \textsc{pst}.\textsc{ipfv}-not.exist \textsc{lnk} { } \textsc{inf}-walk completely \textsc{emph} \textsc{ipfv}-\textsc{genr}:S/O-go \textsc{pst}.\textsc{ipfv}-be.needed \\
...
\gll iʑora nɤki, cʰɤlɤnnɤ ɣɯ́-znɯzdɯxpa-j tɕe ɣɯ́-lɤt-i tʰaŋ wo \\
...
These postverbal adverbs are placed between the main verb and the auxiliary \japhug{ŋu}{be} in periphrastic tenses (§\ref{sec:ipfv.periphrastic.TAME}), as in (\ref{ex:ntsW.Nu}).

\begin{exe}
\ex \label{ex:ntsW.Nu}
\gll nɯnɯ tɯ-ji ɯ-ŋgɯ ɣɯ-chɯ-nɤru \textbf{ntsɯ} ŋu \\
\textsc{dem} \textsc{indef}.\textsc{poss}-field \textsc{3sg}.\textsc{poss}-in \textsc{cisl}-\textsc{ipfv}-eat.crops always be:\textsc{fact} \\
\glt `It comes to eat crops in the fields all the time.' (phaRrgot WzrWru) \japhdoi{0006129\#S12} 
\end{exe}
...
\end{exe}
 ...
 \begin{exe}
	...
	\gll  aʑo jɤɣɤt ci lu-ɕe-a nɤ \\
		 toilet a.little \textsc{indef} \textsc{ipfv}:\textsc{upstream}-go-\textsc{1sg} \textsc{sfp} \\
...
\textsc{1pl}.\textsc{poss}-father \textsc{comit} alcohol \textsc{ipfv}-drink-\textsc{du} sofa \textsc{3sg}.\textsc{poss}-on \textsc{loc} \textsc{ipfv}-sleep.on.opposite.directions-\textsc{du} \textsc{lnk} \textsc{ipfv}-lie.down-\textsc{du} \textsc{lnk} \textsc{lnk} \textsc{3sg}.\textsc{poss}-order \textsc{emph} \textsc{ipfv}-\textsc{refl}-\textsc{caus}-not.exist-\textsc{du} \textsc{sens}-be.\textsc{aff}   \\
...
\gll tɯ-skʰrɯ mɤ-βdi tɕe nɯnɯ qartsʰaz ɯ-se ɣɯ́-tsʰi mɤ-βdi ma \\
...
\gll nɯnɯ qale a-tɤ-βze qʰe, iɕqʰa nɯ ɣɯ́-nɯ-tsɯm qʰe,  \\
...
\gll ndaŋ ta-lɤt ɕti  \\
think.about 1$\to$2-release:\textsc{fact} be.\textsc{aff}:\textsc{fact} \\
\end{xlist} 
...
\textsc{1sg} mouse be.\textsc{aff}:\textsc{fact}-\textsc{1sg} \textsc{lnk} \textsc{filler} bird not.be:\textsc{fact}-\textsc{1sg} \\
...
\textsc{2sg} \textsc{2sg}.\textsc{poss}-\textsc{indef}.\textsc{poss}-water \textsc{tral}-\textsc{aor}-2-\textsc{auto}-bring-\textsc{pst}:\textsc{tr}  \textsc{qu}-be:\textsc{fact} \\
...
\textsc{lnk} \textsc{3sg}.\textsc{poss}-elder.sibling \textsc{neg}-\textsc{ifr}.\textsc{ipfv}-stay \textsc{lnk} \textsc{3sg}.\textsc{poss}-aunt \textsc{dem} \textsc{ifr}.\textsc{ipfv}-stay be.\textsc{aff}:\textsc{fact} \textsc{lnk} \\
...
\textsc{1sg}  \textsc{anthr} \textsc{ipfv}-say-\textsc{1sg} be.\textsc{aff}:\textsc{fact} \textsc{lnk} \textsc{2sg} \textsc{ipfv}-1$\to$2-\textsc{appl}-call not.be:\textsc{fact} \\
...
window \textsc{loc} bird \textsc{du} \textsc{sens}-play-\textsc{du} \textsc{lnk} \textsc{dem} \textsc{ipfv}-lauɡh-\textsc{1sg}  be.\textsc{aff}:\textsc{fact} \textsc{sfp} \\
...
\textsc{aor}-see-\textsc{pst}:\textsc{tr}-\textsc{1sg} at.all  not.exist:\textsc{fact} \\
...
\textsc{lnk} nowadays \textsc{1sg} \textsc{aor}-see-\textsc{pst}:\textsc{tr}-\textsc{1sg} not.exist:\textsc{fact} \textsc{lnk} \textsc{aor}-\textsc{genr}:S/O-be.small \textsc{lnk} \textsc{aor}-\textsc{inv}-see \\
...
\textsc{lnk} \textsc{3pl} \textsc{3pl}.\textsc{poss}-\textsc{obj}:\textsc{pcp}-\textsc{auto}-eat \textsc{lnk} completely plant:\textsc{fact}-\textsc{pl} not.exist:\textsc{sens} \textsc{sfp} \\
