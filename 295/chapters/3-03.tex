...
The Tibetan ordinal numbers up to ten (and the cardinal numbers for `eleven' and `twelve'), indicated in \tabref{tab:tibetan.ordinals}, can be used for months names \citep[\#406]{tournadre23tibetic}. This usage is not attested in conversations, but does occur in texts when  speakers consciously try to avoid using Chinese words. In example (\ref{ex:XsWmba}), \iai{Tshendzin} first used the Chinese \ch{三月份}{sānyuèfèn}{third month} and then corrected it to its Tibetan equivalent. 
...
one-place \textsc{dem}:\textsc{loc} two three four about \textsc{ipfv}-\textsc{acaus}:attach \\
...
\gll ɯʑo nɯnɯ ɕnɤcat ci tɤ-kɤ-sɯ-pa jamar ʑo qarma wxti ri, \\
\textsc{3sg} \textsc{dem} seven.or.eight one \textsc{aor}-\textsc{obj}:\textsc{pcp}-\textsc{caus}-do about \textsc{emph} eared.pheasant be.big:\textsc{fact} but \\
\glt `Although the eared pheasant is as big as about seven or eight of them (weasels) put together.' (27-spjaNkW)
\japhdoi{0003704\#S54}
\end{exe}
...
\gll  tɕe nɯnɯ kɤntɕʰɯ-tɯpɯ ɣɯ nɯ-tɯrsa ɯ-sta ɲɯ-ŋu ma \\
 \textsc{lnk} \textsc{dem} many-household \textsc{gen} \textsc{3pl}.\textsc{poss}-grave \textsc{3sg}.\textsc{poss}-place \textsc{sens}-be \textsc{lnk} \\
...
\textsc{lnk} eared.pheasant \textsc{dem} one-night \textsc{lnk} four five about \textsc{ipfv}-kill-\textsc{pl}, one-piece person one-piece \textsc{erg} \\
\glt `Eared pheasants, in one night, each of [the hunters] can kill four or five of them.' (23-qapGAmtWmtW) \japhdoi{0003608\#S146}
\end{exe}
...
\gll ʑɯrɯʑɤri qʰe, tɕe tɯ-tɯ-rdoʁ nɯ ɲɯ-ʑɣɤqɤr-nɯ qʰe \\
...
mountain \textsc{sbj}:\textsc{pcp}-be.tall \textsc{lnk} oak \textsc{sbj}:\textsc{pcp}-be.big \textsc{pl} \textsc{dem} \textsc{3sg}.\textsc{poss}-between \textsc{loc} \textsc{3sg}.\textsc{poss}-\textsc{part}\redp{}tree \textsc{emph} exist:\textsc{fact} \textsc{lnk} \\
...
\begin{exe}
	...
	\glt `Each household used to have horses, ...' (150820 kAnWCkat)
\end{exe} 
...
\begin{exe}
	...
	winter \textsc{lnk} \textsc{3sg}.\textsc{poss}-leaf one-leaf not.even \textsc{3sg}.\textsc{poss}-head \textsc{sbj}:\textsc{pcp}-\textsc{acaus}:attach not.exist:\textsc{fact} \\ 
...
\glt `They had made two piles from the bones.' (2002nyimavodzer)
\end{exe}
...
ten-bushel \textsc{lnk} \textsc{lnk} \textsc{dem} ten.bushels \textsc{sens}-be  \textsc{lnk}  ten.bushels \textsc{sens}-be ten.bushels  \textsc{dem} \textsc{lnk} \textsc{lnk} even.more thirty-bushel \textsc{irr}-\textsc{pfv}-accumulate \textsc{lnk} \textsc{lnk} \textsc{dem} one-thirty.bushels  \textsc{lnk} dem one-thirty.bushels \textsc{ifr}.\textsc{ipfv}-be \textsc{lnk} \textsc{lnk} \textsc{dem} up.from \textsc{3sg}.\textsc{poss}-\textsc{obl}:\textsc{pcp}-measure \textsc{ifr}.\textsc{ipfv}-not.exist \textsc{lnk} \\
...
jar \textsc{3sg}.\textsc{poss}-inside \textsc{ipfv}:\textsc{downstream}-2$\to$1-put.in-\textsc{1sg} three-days \textsc{aor}-pass-\textsc{1sg} \textsc{lnk} once \textsc{irr}-\textsc{pfv}-2$\to$1-look-\textsc{1sg} \\
...
year three-year \textsc{pst}.\textsc{ipfv}-walk-\textsc{1pl} \textsc{pst}.\textsc{ipfv}-be.needed \textsc{lnk} \\
...
every.evening \textsc{emph} {street} \textsc{1sg}.\textsc{poss}-elder.sibling \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{sbj}:\textsc{pcp}-have.supper \textsc{ipfv}:\textsc{west}-come-\textsc{1sg} ... \textsc{pst}.\textsc{ipfv}-be \\
\glt `Every evening, I would go in the town at my elder brother's home to have supper and...' (140501 tshering skyid)
...
\gll kɯmŋu ɯ-taʁ tɯ-rdoʁ pjɯ́-wɣ-ta tɕe kɯtʂɤɣ tu-βze ŋu.  \\
 five \textsc{3sg}.\textsc{poss}-on one-piece \textsc{ipfv}:\textsc{down}-\textsc{inv}-put \textsc{lnk} six \textsc{ipfv}-do[III] be:\textsc{fact} \\
...
\gll  nɤʑo kɯɕnɯ-kɯrcat nɯ pɯpɯŋu nɤ, kɯɕnɯz ɯ-taʁ kɯrcat pjɯ́-wɣ-ta tɕe sqamŋu ɲɯ-ŋu sqamŋu tɕe ju-tɯ-nɯ-ɕe ɲɯ-ŋu tɕe, \\
 \textsc{2sg} seven-eight \textsc{dem} as.for \textsc{lnk} seven  \textsc{3sg}.\textsc{poss}-on eight \textsc{ipfv}:\textsc{down}-\textsc{inv}-put \textsc{lnk}  fifteen   \textsc{sens}-be fifteen \textsc{lnk} \textsc{ipfv}-2-\textsc{vert}-go \textsc{sens}-be \textsc{lnk} \\
...
\gll kɯmŋu ɯ-ŋgɯ tɯ-rdoʁ cʰɯ́-wɣ-tɕɤt tɕe kɯβde ma ɲɯ-me ŋu \\
 five \textsc{3sg}.\textsc{poss}-inside one-piece \textsc{ipfv}-\textsc{inv}-take.out \textsc{lnk} four apart.from \textsc{ipfv}-not.exist be:\textsc{fact} \\
...
\gll kɯmŋu-tɯcɯr ɯ-ŋgɯ χsɯ-tɯcɯr  \\
 five-part \textsc{3sg}.\textsc{poss}-inside three-part \\
