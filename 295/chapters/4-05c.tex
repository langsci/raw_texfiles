...
The autive derivation in Japhug does not cause any stem alternation, unlike in other languages such as Bragbar \citep{zhangshuya20these}.
...
\textsc{lnk} louse \textsc{dem} \textsc{lnk} some \textsc{erg} \textsc{indef}.\textsc{poss}-navel \textsc{3sg}.\textsc{poss}-inside \textsc{ipfv}-\textsc{auto}-come.out be:\textsc{fact} \textsc{ipfv}-say-\textsc{pl}  be:\textsc{fact} \textsc{lnk} \textsc{neg}-\textsc{genr}:A:know \textsc{lnk} \textsc{3sg} \textsc{ipfv}-\textsc{sbj}:\textsc{pcp}-\textsc{auto}-grow \textsc{indef} \textsc{sens}-be.\textsc{aff} \textsc{lnk} \\
...
\textsc{1sg} \textsc{ipfv}:\textsc{down}-2$\to$1-\textsc{auto}-throw-\textsc{1sg}-\textsc{pl} \textsc{neg}-be.needed:\textsc{fact} \textsc{1sg} \textsc{ipfv}:\textsc{down}-\textsc{auto}-jump-\textsc{1sg} be.allowed:\textsc{fact} \\
...
\textsc{2sg} \textsc{imp}-\textsc{auto}-cry \textsc{lnk} \textsc{2sg}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-\textsc{appl}-be.afraid not.exist:\textsc{fact} \textsc{lnk} \textsc{neg}-1$\to$2-give:\textsc{fact} \\
...
\textit{Russula\_foetens} \textsc{comit} Matsutake \textsc{sbj}:\textsc{pcp}-be.like \textsc{aor}-come.out \textsc{lnk} \textsc{idph(II):}spherical \textsc{sbj}:\textsc{pcp}-auxiliary \textsc{lnk} progressively \textsc{ipfv}-\textsc{sbj}:\textsc{pcp}-open.towards.the.exterior \textsc{dem} \textsc{sens}-not.be  \textsc{aor}-come.out when \textsc{sens}-be.small only \textsc{dem} \textsc{sbj}:\textsc{pcp}-be.like \textsc{sens}-\textsc{auto}-\textsc{emph}\redp{}be \textsc{lnk}\\
\glt `It is not like the \textit{Russula foetens} and the Matsutake, which are spherical when they come out and progressively open towards the exterior. It is just that it is small when it comes out, [otherwise] it is already like that.'  (24-zwArqhAjmAG)
\japhdoi{0003630\#S17}
 \end{exe}
...
west \textsc{aor}:\textsc{west}:3\flobv{}-start-\textsc{pl} \textsc{lnk} west \textsc{loc} \textsc{neg}-\textsc{sbj}:\textsc{pcp}-obtain \textsc{3sg}.\textsc{poss}-following always \textsc{ipfv}-happen.to.be.at \textsc{ifr}.\textsc{ipfv}-be \\
...
\textsc{dem}.\textsc{prox} \textsc{sbj}:\textsc{pcp}-be.pointy \textsc{dem} \textsc{3sg}.\textsc{poss}-saliva \textsc{ipfv}:\textsc{down}-\textsc{sbj}:\textsc{pcp}-come \textsc{3sg}.\textsc{poss}-direction \textsc{dem} \textsc{ipfv}-\textsc{inv}-\textsc{caus}-happen.to.be.at \\
...
\textsc{2sg}.\textsc{poss}-ornament \textsc{dem}:\textsc{pl} \textsc{1sg} \textsc{indef} \textsc{ipfv}-2$\to$1-\textsc{caus}-take-\textsc{1sg} \textsc{lnk} \\
...
\begin{exe}
	...
	\textsc{lnk} \textsc{ipfv}:\textsc{west}-2-chase[III] \textsc{lnk} \textsc{lnk} \textsc{3pl} \textsc{ipfv}:\textsc{east}-auto-come.back-\textsc{pl} be:\textsc{fact} \textsc{qu} \textsc{tral}-\textsc{ipfv}:\textsc{east}-2-chase[III] be.needed:\textsc{fact}\\
...
\gll aʑɯɣ nɯ-nɯβde-t-a nɯ ɯ́-ŋu tɯ-ci kɯ tʰa-nɯ-tsɯm nɯ ɯ́-ŋu\\
...
one-time \textsc{ipfv}:\textsc{down}-1$\to$2-\textsc{caus}-\textsc{vert}-go be.allowed:\textsc{fact} \textsc{lnk} \\
...
\textsc{3pl}.\textsc{poss}-\textsc{neg}-\textsc{obj}:\textsc{pcp}-\textsc{abil}-eat \textsc{dem} \textsc{3pl}.\textsc{poss}-room \textsc{3sg}.\textsc{poss}-in \textsc{dem}:\textsc{loc} \textsc{3sg}.\textsc{poss}-keep(1) \textsc{ipfv}-\textsc{auto}-keep(2)-\textsc{pl} \textsc{sens}-be.usually.the.case \\
...
\gll  ɯ-ʁar ra ko-tsʰoʁ-nɯ tɕe tɕendɤre, rɟɤlpu nɯ cʰonɤ aʁɤndɯndɤt ju-nɯqambɯmbjom-ndʑi tɕe ju-nɤɕɯɕe-ndʑi ra to-kʰɯ ɲɯ-ŋu. \\
...
Stative verbs, including adjectives, are usually incompatible with the distributed action derivation. The resulting form would be formally identical to the estimative (§\ref{sec:estimative}) with emphatic reduplication (§\ref{sec:emph.redp}). The only adjective with such a derivation is \japhug{sɲu}{be mad} (from \tibet{སྨྱོ་}{smʲo}{be crazy}), which yields \forme{nɤsɲɯsɲu} `be a little crazy, do crazy things (intermittently)', attested in (\ref{ex:pjWnAsYWsYu}).\footnote{
...
\textsc{prohib}-\textsc{imp}-2-move \textsc{lnk} \textsc{neg}-be.efficient:\textsc{fact} \\
...
\textsc{1sg} Tibetan-language \textsc{inf}-learn \textsc{dem} \textsc{ipfv}-be.determined-\textsc{1sg} \textsc{emph} be.\textsc{aff}:\textsc{fact} \\
...
\textsc{indef}.\textsc{poss}-son most \textsc{sbj}:\textsc{pcp}-be.big \textsc{dem} \textsc{erg} \textsc{dem} girl \textsc{dem} \textsc{neg}-\textsc{aor}-\textsc{inf}-obtain \textsc{dem} really \textsc{emph} \textsc{ifr}-\textsc{estim}-be.unpleasant \\
...
\glt `The girl stayed in the house, prepared meals for them, and did the housework.' (140504 baixuegongzhu-zh)
\japhdoi{0003907\#S97}
\end{exe}
...
\textsc{ipfv}-2$\to$1-\textsc{caus}-make.up-\textsc{1du} be.needed:\textsc{fact} \\
...
The transitive verb \japhug{rɤɣrɯɣ}{cherish} comes from the intransitive \japhug{rɯɣ}{be precious} with a estimative meaning (`consider to be precious', §\ref{sec:estimative.other.construction}). The derivational prefix here \forme{rɤɣ\trt}, with an intrusive velar fricative (on which see §\ref{sec:caus.sWG} and the references therein).
...
\textsc{lnk} \textsc{dem}  \textsc{anthr} \textsc{dem} \textsc{dem} \textsc{3pl}.\textsc{poss}-leader \textsc{aor}:3\flobv{}-choose-\textsc{pl} \textsc{erg}  \textsc{anthr} \textsc{dem} \textsc{ifr}-\textsc{caus}-attach \\
...
Third,  the verb of perception \japhug{ɣɯχsɤl}{realize} (§\ref{sec:tso.sWXsAl}) originates from \japhug{χsɤl}{be clear} (itself from \tibet{གསལ་}{gsal}{clear}), with a quasi-estimative meaning  `clearly perceive that $X$'.
