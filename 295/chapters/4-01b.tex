...
Stem III in \forme{-ɤm} undergoes regular vowel assimilation to \forme{-am-} when followed by a \textsc{1sg} \forme{-a} suffix (§\ref{sec:intr.1}). For instance, the \textsc{1sg}$\to$\textsc{3sg} Factual Non-Past of \japhug{mto}{see} is \forme{mtam-a} `I (will) see it/him/her' rather than $\dagger$\forme{mtɤm-a}. Stem III with the fronted vowel \forme{-e} change to \forme{-i} when followed by \forme{-a}: \forme{ndze-a} `I (will) eat it' is realized as \phonet{ndzia}.
...
\midrule
\textsc{1sg}$\to$\textsc{3sg} & III & \forme{mtam-a} \\
\textsc{1sg}$\to$\textsc{3du} & III & \forme{mtam-a-ndʑi} \\
\textsc{1sg}$\to$\textsc{3pl} & III & \forme{mtam-a-nɯ} \\
\textsc{2sg}$\to$3 & III & \forme{tɯ-mtɤm} \\
\textsc{3sg}\flobv{} & III & \forme{mtɤm} \\
\midrule
\textsc{1du}$\to$3 & I & \forme{mto-tɕi} \\
\textsc{2du}$\to$3 & I & \forme{tɯ-mto-ndʑi} \\
...
The optional \forme{-t} is not synchronically relatable to the past tense \forme{-t}, which is restricted to \textsc{1sg}$\to$3 and \textsc{2sg}$\to$3 Aorist and Inferential  (§\ref{sec:indexation.mixed}), and never appears on intransitive forms, or to any of the frozen derivation \forme{-t} suffixes (§\ref{sec:applicative.t}, §\ref{sec:antipassive.t}).  
...
\japhdoi{0003364\#S114}
 ...
 \begin{exe}
 	...
 	\textsc{1sg}.\textsc{poss}-father word three-word \textsc{ipfv}-say-\textsc{1sg} \textsc{qu}-\textsc{epenth}-have.time:\textsc{fact} \\
 ...
 With inner prefixes, vowel contraction is also straightforward and yields \forme{ɤ-} in all cases: for instance, the sigmatic causative, applicative and estimative of contracting verbs are \forme{sɯ-ɤ-} \ipa{sɤ-} (§\ref{sec:caus.sA}), \forme{nɯ-ɤ-} \ipa{nɤ-} (§\ref{sec:allomorphy.applicative}) and \forme{nɤ-ɤ-} \ipa{nɤ-} (§\ref{sec:estimative.allomorphy}), respectively. The autive \forme{nɯ-} cannot undergo vowel fusion and is rather infixed after the contracting vowel \forme{a-} (§\ref{sec:inner.prefixal.chain}, §\ref{sec:autoben.position}).
 ...
 \begin{table}
 	...
 	\begin{tabular}{lllllll}
 		...
 		2$\to$1 & -2 &\forme{kɯ-}  & \forme{kɯ-ɤsɯ\trt}, \forme{kɯ-ɤz-}& \ipa{kɤsɯ\trt}, \ipa{kɤz-} \\
...
\textsc{1sg}.\textsc{poss}-son \textsc{cond}\redp{}2-be:\textsc{fact} \textsc{add} \textsc{aor}-1$\to$2-teach \textsc{dem} once \textsc{imp}-read be.needed:\textsc{fact} \\
...
\textsc{cond}\redp{}\textsc{aor}-2-say[II] \textsc{add} \textsc{lnk} \textsc{ipfv}-1$\to$2-kill be:\textsc{fact} \\
...
The reduplicated autive should not be mistaken with the combination of a type A \textsc{westward} orientation preverb \forme{nɯ-} with the autive in spontaneous function (§\ref{sec:autoben.spontaneous})  as in (\ref{ex:nWnWme}).
...
\gll nɤ-wa pɯ-nnɯ-mɯ\redp{}me ɕti \\
 \textsc{2sg}.\textsc{poss}-father \textsc{pst}.\textsc{ipfv}-\textsc{auto}-\textsc{emph}\redp{}not.exist be.\textsc{aff}ː\textsc{fact} \\
