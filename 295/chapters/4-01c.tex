...
\begin{exe}
	\ex \label{ex:WmAtaZa}
	\gll tɕe tɯ-ŋke ɯ-mɤ́-ta-ʑa, ɯ-mɤ́-nɯ-mɯnmu qʰe mɯ́j-sɤ-mto \\
...
\begin{exe}
	...
	\textsc{cond}\redp{}\textsc{neg}-\textsc{aor}-die-\textsc{1sg} \textsc{add} \textsc{irr}-\textsc{pfv}-2$\to$1-hit.with.forelegs-\textsc{1sg} be.needed:\textsc{fact} \\
...
\subsection{Expletive negation} \label{sec:expletive.neg}
Expletive negative prefixes are found in temporal clauses with the postposition 
\japhug{mɤɕtʂa}{until}  (§\ref{sec:terminative.clause}), as in (\ref{ex:mWtAtWta.mACtsxa}).
...
In this type of subordinate clauses,  polarity is neutralized.
...
\begin{exe}
	...
	\glt `Nobody will [be able] to catch up with you.' (2003 qachGa)
