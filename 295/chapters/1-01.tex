...
Japhug is one of the four Core Gyalrong languages \citep{jackson00sidaba,gong18these,zhangshuya20these,sangji25marong}, Tshobdun, Zbu and Situ, represented in \figref{fig:map.rgyalrong}. It is particularly closely related to the West Gyalrongic languages: Khroskyabs, Stau, Phosi, Geshiza, Nyagrong Minyag, Tangut (\citealt{jackson00puxi, jacques17stau, honkasalo19geshiza, lai20tangut, liuzhenyang23nyagrong,liuzhenyang25phosi}) and more remotely to the Smar languages spoken in Tibet \citep{tashi2019newly, zhaohaoliang24smar}.
...
A short grammar \citep{jacques08}, some texts \citep{jacques10gesar} and a dictionary (\citealt{jacques15japhug}, \citealt{bonnet17lexica}) have been previously published. A corpus of transcribed stories on the Pangloss archive \citep{michailovsky14pangloss, michaud16auco} is available on \url{https://pangloss.cnrs.fr/corpus/Japhug}. An update of the dictionary is in preparation \citep{galliot25japhug}.
...
A system of automatic speech recognition has been devised for Japhug \citep{wisniewski20transcription,guillaume22jep,guillaume22recognition}, which makes it possible to enrich the Japhug corpus more effectively with less manual labor. 

Japhug data from the first edition of this grammar was employed in experimental studies of weakly supervised word segmentation \citep{okabe22weakly-supervised,okabe23faiblement-supervises}.
