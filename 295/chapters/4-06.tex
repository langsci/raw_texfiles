...
\gll [ɯ-rʑaβ nɯ ɯ-skʰrɯ mɯ-nɯ-kɯ-βdi] nɯ, cʰɤ-rɤ-rɟit \\
 \textsc{3sg}.\textsc{poss}-wife \textsc{dem} \textsc{3sg}.\textsc{poss}-body \textsc{neg}-\textsc{aor}-\textsc{sbj}:\textsc{pcp}-be.well \textsc{dem} \textsc{ifr}-\textsc{denom}-child \\
...
\textsc{lnk} \textsc{3sg}.\textsc{poss}-before \textsc{aor}:3\flobv{}-say[II] \textsc{comit} \textsc{3sg}.\textsc{poss}-after  \textsc{aor}:3\flobv{}-say[II] \textsc{dem}:\textsc{pl} at.all \textsc{neg}-\textsc{ifr}.\textsc{ipfv}-\textsc{peg}-\textsc{denom}-pair-\textsc{peg} \\
...
The historical relationship between denominal \forme{sɤ-} and \forme{nɤ-} prefixes on the one hand, and proprietive and estimative prefixes on the other hand, is explored in §\ref{sec:sA.history}.

Proprietive denominal verbs in \forme{sɤ-} do not have estimative forms, and instead form the corresponding \forme{nɤ-} denominal verb instead. For instance \japhug{sɤŋaβ}{be unpleasant}, `be embarrassing' (\ref{ex:sANAB}) lacks a estimative $\dagger$\forme{nɤ-sɤŋaβ}, and instead requires the corresponding transitive denominal estimative \japhug{nɤŋaβ}{consider to be unpleasant}, `be embarrassed by/to' (\ref{ex:kWnANAB}).
...
demoness \textsc{dem} \textsc{erg} early \textsc{inf}-say \textsc{3sg}.\textsc{poss}-throat \textsc{neg}-\textsc{sbj}:\textsc{pcp}-come.out \textsc{lnk} \textsc{inf}-say \textsc{sbj}:\textsc{pcp}-\textsc{denom}:\textsc{estim}-unpleasant \textsc{ifr}-pretend \textsc{lnk} \\
\glt `The demoness pretended to be embarrassed to say it for a long time.' (28-smAnmi)
\japhdoi{0004063\#S40}
\end{exe}
...
\ex \label{ex:mAkWsAGa}
 \gll  tsʰɤwɤre nɯnɯ, aʁɤndɯndɤt ʑo tɕe, ɯ-jaʁ-pa nɯ wuma ʑo ɲɯ-ɤ-ɲɟoʁ tɕe, tsʰi kɯ-fse ʑo mɤ-kɯ-sɤɣa tɤ-a<nɯ>ri kɯnɤ pjɯ-ɤtɤr mɯ́j-cʰa. \\
...
\textsc{prohib}-\textsc{imp}-2-\textsc{denom}:\textsc{prop}-anger \\
...
\ex \label{ex:YWlAt.YWBze}
 ...
 \glt `[The \textit{Zanthoxylum}] makes leaves and grows fruits.' (07-tCGom)
\japhdoi{0003434\#S21}
 \end{exe}
...
\ex \label{ex:rWRlAwWr}
 \gll kʰɤrɯm nɯnɯ, tɯ-mtɕʰi ɯ-taʁ ʑmbɤr ɲɯ-kɯ-ɬoʁ ŋu. tɕe wuma ʑo rɯ-ʁlɤwɯr    \\
...
\ex \label{ex:chWwGrAtGa}
 ...
 how.much \textsc{sbj}:\textsc{pcp}-be.needed \textsc{dem} \textsc{ipfv}:\textsc{downstream}-\textsc{inv}-\textsc{denom}-handspan  \\
...
\begin{table}
\caption{Transitive denominal verbs in \forme{ɣɯ-/ɣɤ-}} \label{tab:denom.GA.intr}
\begin{tabular}{llll}
\lsptoprule
Base noun & Denominal verb \\
\midrule
...
Among these verbs, \japhug{ɣɤtɕa}{be wrong} is one of the few intransitive verbs that can be reflexivized with the \forme{ʑɣɤ-} prefix (§\ref{sec:refl.intr}), with a reflexive estimative meaning \japhug{ʑɣɤɣɤtɕa}{recognize one's mistake}. 
...
\begin{table}
\caption{Transitive denominal verbs in \forme{ɣɯ-/ɣɤ-}} \label{tab:denom.GA.tr}
\begin{tabular}{llll}
\lsptoprule
Base noun & Denominal verb \\
\midrule
...
\tablevspace 
\japhug{qarma}{eared pheasant, \textit{Crossoptilon}} & \japhug{nɯqarma}{search for eared pheasants} \\
...
\ex \label{ex:pjAnWmdoR}
 \gll <maji> nɯnɯ [ɯ-sni mɤ-kɯ-ɲaʁ] pjɤ-nɯ-mdoʁ  \\
  \textsc{anthr} \textsc{dem} \textsc{3sg}.\textsc{poss}-heart \textsc{neg}-\textsc{sbj}:\textsc{pcp}-be.black \textsc{ifr}.\textsc{ipfv}-\textsc{denom}-colour \\
...
\ex \label{ex:tWGur.pata}
 ...
 frost \textsc{aor}:3\flobv{}-put \textsc{sbj}:\textsc{pcp}-be.many \textsc{emph} \textsc{neg}-\textsc{aor}:3\flobv{}-put \\
...
\textsc{2sg}.\textsc{poss}-lunch \textsc{qu}-\textsc{pst}.\textsc{ipfv}-exist \\
...
\gll χpɯnbu la-ndo \\
 master \textsc{aor}:3\flobv{}:\textsc{upstream}-take \\
...
Base noun & Denominal verb \\
\midrule  
\japhug{tɤ-pɤtso}{child} & \japhug{nɯtɤpɤtso}{treat as a child} \\ %estimative
...
First, transitive denominal verbs in \forme{nɯ-/nɤ-} can have a estimative function `treat/consider $Y$ as $X$', as in the case of \japhug{nɯʁgra}{treat as an enemy} from \japhug{ʁgra}{enemy}. The verb \forme{nɯʁjoʁ} `give orders to' (from `treat as a servant') from \japhug{ʁjoʁ}{servant} is labile, and means `work as a servant' when conjugated intransitively. It is one of the very few verbs with ergative lability in Japhug (see §\ref{sec:lability.pass}).


The opposite (anti-estimative) meaning `be treated as $X$ by $Y$' is found in \japhug{nɤme}{be adopted as a daughter}  (from \japhug{tɯ-me}{daughter}: `become $Y$'s daughter'), the transitive equivalent of the \forme{mɤ-} derivation found in the intransitive verb \japhug{mɤtɕɯ}{be adopted as a son} (from  \japhug{tɤ-tɕɯ}{son}, §\ref{sec:denom.mA}). 
...
\japhug{tɤ-mkɯm}{pillow} & \forme{mkɯm} `have one's head  &  \zh{枕} \forme{*t.kəmʔ} $\to$ \forme{tɕimX} `pillow' \\
& turned towards' \\
\tablevspace
\japhug{tɤjpɣom}{ice} & \japhug{jpɣom}{freeze} &  \zh{冰} \forme{*rpəm} $\to$ \forme{piŋ} `ice' \\
\tablevspace
...
\textsc{lnk} snake frog { } \textsc{ifr}.\textsc{ipfv}-\textsc{deidph}:\textsc{intr}-wiggling \textsc{emph} be.\textsc{aff}:\textsc{fact} \\
...
stone \textsc{aor}:3\flobv{}-\textsc{deidph}-heavy.object \textsc{emph}  \textsc{aor}:3\flobv{}:\textsc{down}-throw \\
\ex \label{ex:pasAbAbAB.paBde}
\gll   pa-sɤ-bɤbɤβ ʑo pa-βde \\
  \textsc{aor}:3\flobv{}-\textsc{deidph}-heavy.object \textsc{emph}  \textsc{aor}:3\flobv{}:\textsc{down}-throw \\
\ex \label{ex:bABnAbAB.paBde}
\gll bɤβnɤbɤβ ʑo pa-βde \\
\textsc{idph}(III):heavy.object \textsc{emph}  \textsc{aor}:3\flobv{}:\textsc{down}-throw \\
...
\textsc{sbj}:\textsc{pcp}-be.rich \textsc{pl} \textsc{gen} \textsc{3pl}.\textsc{poss}-son \textsc{dem}:\textsc{pl} \textsc{erg} girl \textsc{indef} \textsc{ifr}.\textsc{ipfv}-\textsc{peg}-\textsc{prog}-\textsc{deidph}-in.group-\textsc{pl}-\textsc{peg} \\
...
Estimative \forme{nɤ(ɣ)-} & §\ref{sec:estimative} & Transitive denominal \forme{nɤ-} & §\ref{sec:denom.nW.pairing}  \\
\tablevspace
...
\subsection{The proprietive and antipassive \forme{sɤ-} prefixes and their estimative counterpart} \label{sec:sA.history} 
...
\gll  a-taʁ nɤ-zgrɯ-tɕʰɯ ma-tɤ-tɯ-lɤt ma ɲɯ-mŋɤm  \\
  \textsc{1sg}.\textsc{poss}-on \textsc{2sg}.\textsc{poss}-elbow-stab \textsc{prohib}-\textsc{imp}-2-release \textsc{lnk} \textsc{sens}-hurt \\
...
\textsc{prohib}-\textsc{imp}-2-be.afraid \textsc{lnk} \textsc{1sg} \textsc{neg}-1$\to$2-\textsc{denom}-heart-black:\textsc{fact} \\
...
Third, the transitive verbs \japhug{nɤrɕɤmŋɤm}{cherish}  and \japhug{nɤʁombi}{lose hope} have a estimative meaning (§\ref{sec:denom.tr.nW}). Their transitive subjects corresponds to the possessor of the base noun, as shown by (\ref{ex:YWnArCAmNama}) and (\ref{ex:arCa.mNAm}).
...
Other incorporating verbs probably originate from a Noun+Verb collocation which does not exist anymore. From instance, \japhug{amɲaχtsʰɯm}{be petty} (\ref{ex:YWtAmYaXtshWm}) derives from \japhug{tɯ-mɲaʁ}{eye} and \japhug{xtsʰɯm}{be thin} with the denominal prefix \forme{a\trt}, but no collocation \forme{*tɯ-mɲaʁ+xtsʰɯm} exists, though the etymological relationship with the base noun and verb is still synchronically transparent.
...
\gll maka lu-kɯ-nɤ-pʰɯ-xtsɯ tɕe tɕe rcanɯ, tɤ-pʰɯ lú-wɣ-xtsɯ tɕe, \\
...
\textsc{anthr}  \textsc{anthr} \textsc{3sg} apart.from \textsc{emph} \textsc{aor}-\textsc{denom}-back-look-\textsc{pl} \textsc{sens}-be \textsc{total}\redp{}\textsc{sbj}:\textsc{pcp}-exist \textsc{emph} \textsc{aor}-fall-\textsc{pl} \textsc{sens}-be \\
...
\glt `The two of them disappeared, and the only thing she could do was looking at them from behind (at their back as they were going away).' (140506 shizi he huichang de bailingniao-zh)
