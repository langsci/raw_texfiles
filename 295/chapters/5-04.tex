...
\textsc{dem} \textsc{aor}:3\flobv{}-plough-\textsc{pl} \textsc{comit}  \textsc{aor}:3\flobv{}-dig-\textsc{pl} \textsc{lnk} \textsc{lnk} earthworm \textsc{ipfv}-\textsc{auto}-come.out \textsc{sens}-be \textsc{lnk} \textsc{dem} \textsc{tral}-\textsc{ipfv}-collect \textsc{lnk} \textsc{ipfv}-eat[III] \textsc{sens}-be \\
...
\ex \label{ex:ki.tuste.luznaRje}
 ...
 \textsc{lnk} \textsc{3sg}.\textsc{poss}-hand \textsc{erg} \textsc{dem}:\textsc{prox} \textsc{ipfv}-do.like[III]  \textsc{ipfv}-\textsc{caus}-reach.into[III] \textsc{sens}-be   \\
...
\textsc{lnk} \textsc{3sg}.\textsc{poss}-outside \textsc{ipfv}-go \textsc{lnk} one one bird \textsc{ipfv}-kill \textsc{ipfv}-bring one one mouse \textsc{ipfv}-kill \textsc{ipfv}-bring one one zokor \textsc{pl} \textsc{ipfv}-kill \textsc{lnk} \textsc{ipfv}-bring \\
\glt `(When her kittens are hungry), [the cat mother] goes out and sometimes kills a bird and brings it, sometimes kills a mouse and brings it, sometimes kills a zokor or something and brings it [to them].' (21-lWLU)
\japhdoi{0003576\#S36}
\end{exe}
...
\ex \label{ex:padma.tWtWNu.nA}
 \gll [pɤnmawombɤr tɯ\redp{}tɯ-ŋu] nɤ, pɯ-ta-sɯxɕɤt nɯ nɯ-ndɯn ra \\
  \textsc{anthr} \textsc{cond}\redp{}2-be:\textsc{fact} \textsc{add} \textsc{aor}-1$\to$2-teach \textsc{dem} \textsc{imp}-read be.needed:\textsc{fact} \\
...
\ex \label{ex:mWmAjAtWGWt.nA}
 ...
 fortune thing \textsc{comit} silver \textsc{pl} \textsc{cond}\redp{}\textsc{neg}-\textsc{aor}-2-bring \textsc{add} \textsc{filler} \textsc{ipfv}-1$\to$2-kill be:\textsc{fact} \\
...
\ex \label{ex:anWYatnW.tCe}
 ...
 \textsc{irr}-\textsc{pfv}-be.tired-\textsc{pl} \textsc{lnk} one-pair \textsc{lnk} one-pair \textsc{dem} \textsc{filler} electric.wire \textsc{3sg}.\textsc{poss}-on \textsc{lnk} treetop \textsc{3sg}.\textsc{poss}-on \textsc{dem}:\textsc{loc} \textsc{ipfv}-rest-\textsc{pl} \textsc{lnk} \\
...
\begin{exe}
	...
	\textsc{dem} all \textsc{erg} \textsc{irr}-\textsc{pfv}:\textsc{down}-drink-\textsc{pl} \textsc{lnk} \textsc{dem}  only.then \textsc{add} all \textsc{ipfv}-be.fat-\textsc{pl} be.needed:\textsc{fact} \textsc{lnk} \\
...
\ex \label{ex:chWwGnWBlW.kWnA}
 \gll   [cʰɯ́-wɣ-nɯ-βlɯ] kɯnɤ, tu-nɯt ʁo ŋu ri, ɯ-ʁrɤt nɯ ɲaʁ ʑo qʰe, maka ɲɯ-ɣɤ-mpje mɤ-cʰa. \\
  \textsc{ipfv}-\textsc{inv}-\textsc{auto}-burn also \textsc{ipfv}-be.ignited \textsc{advers} be:\textsc{fact} \textsc{lnk}
...
pasture \textsc{sbj}:\textsc{pcp}-be.like \textsc{aor}-\textsc{auto}-lie.down-\textsc{pl} tree.top \textsc{3sg}.\textsc{poss}-under  \textsc{aor}-\textsc{auto}-lie.down-\textsc{pl} cliff-under \textsc{aor}-\textsc{auto}-lie.down-\textsc{pl} \textsc{dem} \textsc{3pl}.\textsc{poss}-clothes \textsc{3sg}.\textsc{poss}-on \textsc{ipfv}-put-\textsc{pl} \\
...
\gll  [pa-n-nɤla] nɤ ɕe-a, [mɯ-pa-n-nɤla] nɤ ɕe-a ra    \\
 \textsc{pst}.\textsc{ipfv}:3\flobv{}-\textsc{auto}-agree \textsc{lnk} go:\textsc{fact}-\textsc{1sg}
  \textsc{neg}-\textsc{pst}.\textsc{ipfv}:3$\to$-\textsc{auto}-agree \textsc{lnk} go:\textsc{fact}-\textsc{1sg} be.needed:\textsc{fact} \\
...
\textsc{aor}:3\flobv{}-agree \textsc{pst}.\textsc{ipfv}-\textsc{auto}-be \textsc{pst}.\textsc{ipfv}-\textsc{auto}-not.be \textsc{ipfv}:go-\textsc{1sg} be.needed:\textsc{fact} \\
\glt `I will go whether he agrees or not.' (elicited)
\end{exe}
...
\textsc{bare}.\textsc{inf}:go \textsc{neg}-\textsc{bare}.\textsc{inf}:go 2-not.exist:\textsc{fact} \textsc{lnk} \textsc{inf}-work 2-can:\textsc{fact} not.exist:\textsc{fact} \textsc{lnk} be.the.same:\textsc{fact} be.\textsc{aff}:\textsc{fact} \\
...
what \textsc{pst}.\textsc{ipfv}-\textsc{auto}-\textsc{emph}\redp{}be.like \textsc{emph} \textsc{2sg}.\textsc{poss}-together \textsc{ipfv}-2$\to$1-take.away-\textsc{1sg} be.needed:\textsc{fact} \\
...
\begin{exe}
 \ex 
 \gll ʑatsa a-tɤ-tɯ-ti tɕe pɯ-pe \\
 early \textsc{irr}-\textsc{pfv}-2-say \textsc{lnk} \textsc{pst}.\textsc{ipfv}-be.good \\
 \glt `It would have been better if you had said it earlier.'
\end{exe}
...
\textsc{1sg} \textsc{2sg} \textsc{erg} just.before \textsc{dem}:\textsc{loc} \textsc{cisl}-\textsc{ipfv}-2$\to$1-help-\textsc{1sg} \textsc{irr}-\textsc{pst}.\textsc{ipfv}-be \textsc{lnk} \textsc{dem} really \textsc{emph} \textsc{pst}.\textsc{ipfv}-\textsc{estim}-be.good-\textsc{pst}:\textsc{tr}-\textsc{1sg} \textsc{lnk} \\
...
Proxy conditionals, where the speaker puts himself in the point of view of the adressee, are also expressed by the irrealis in the protasis and the past imperfective in the apodosis (\ref{ex:nAZo.apWNua}).

  \begin{exe}
 \ex \label{ex:nAZo.apWNua}
 \gll aʑo nɤʑo a-pɯ-ŋu-a tɕe, nɯ mɯ-pɯ-tɯt-a \\
 \textsc{1sg} \textsc{2sg} \textsc{irr}-\textsc{ipfv}-be-\textsc{1sg} \textsc{lnk} \textsc{dem} \textsc{neg}-\textsc{pst}.\textsc{ipfv}-say[II]-\textsc{1sg} \\
 \glt `If I were you, I would not have said that.' (elicited)
\end{exe}

A counterfactual with the irrealis of the negative copula \japhug{maʁ}{not be} in the apodosis can express the meaning `if not for $X$' as in (\ref{ex:api.apWmaR}) and (\ref{ex:nAZo.apWtWmaR}).

\begin{exe}
 \ex \label{ex:api.apWmaR}
 \gll a-pi a-pɯ-maʁ qhe,  tɕi-tɯ-scit nɯ tɕhi nɤ mɯ-pɯ-nɯ-fse \\
 \textsc{1sg}.\textsc{poss}-elder.sibling \textsc{irr}-\textsc{ipfv}-not.be \textsc{lnk} \textsc{1du}.\textsc{poss}-\textsc{nmlz}:\textsc{deg}-be.happy \textsc{dem} what \textsc{add} \textsc{neg}-\textsc{pst}.\textsc{ipfv}-\textsc{auto}-be.like \\
 \glt `If not for my elder sister, how happy wouldn't we have been !' (Kunbzang 2003)
\end{exe}

\begin{exe}
 \ex \label{ex:nAZo.apWtWmaR}
 \gll nɤʑo a-pɯ-tɯ-maʁ qhe ki mɯ-pɯ-fse-a \\
 \textsc{2sg} \textsc{irr}-\textsc{ipfv}-2-not.be \textsc{lnk} \textsc{dem}.\textsc{prox} \textsc{neg}-\textsc{pst}.\textsc{ipfv}-be.like-\textsc{1sg} \\
 \glt `If not for you, I would not have been like this.' (elicite)
\end{exe}
...
\textsc{anthr} \textsc{erg} come:\textsc{fact}-\textsc{du} about.to \textsc{lnk} donkey \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{3sg} \textsc{erg} \textsc{aor}:3\flobv{}-say[II] \textsc{dem}:\textsc{pl} a.little \textsc{ifr}-remember  \\
...
evening \textsc{ifr}-come \textsc{lnk} soon be.dark:\textsc{fact} \textsc{ifr}.\textsc{ipfv}-be \\
...
The terminative postposition  \japhug{mɤɕtʂa}{until}  (§\ref{sec:terminative}) occurs with finite clauses to express the end point of the event described in the main clause. In terminative clauses, verbs nearly always take an expletive negative prefix (§\ref{sec:expletive.neg}) as in (\ref{ex:mWthaCskWt.mACtsxa}) and (\ref{ex:mWtAtWta.mACtsxa2}), and the polarity contrast is neutralized.
...
\begin{exe}
\ex \label{ex:mWtAtWta.mACtsxa2}
\gll [``jɤ-ɕe jɤɣ'' mɯ-tɤ-tɯt-a] mɤɕtʂa ma-nɯ-tɯ-mɯnmu ra \\
\textsc{imp}-go be.allowed:\textsc{fact} \textsc{neg}-\textsc{aor}-say[II]-\textsc{1sg} until \textsc{prohib}-\textsc{imp}-2-move be.needed:\textsc{fact} \\
...
\gll   [ɯ-mi ra ku-xtɕɤr-nɯ] kóʁmɯz tɤ-lu pjɯ-tɕɤt-nɯ ɲɯ-ra \\
  \textsc{3sg}.\textsc{poss}-foot \textsc{pl} \textsc{ipfv}-attach-\textsc{pl} only.after \textsc{indef}.\textsc{poss}-milk \textsc{ipfv}-take.out-\textsc{pl}  \textsc{sens}-be.needed \\
...
The ditransitive verb \forme{stu} (§\ref{sec:ditransitive.secundative}) is found with transitive verbs, and shares its subject and object with them, as shown by (\ref{ex:ki.tuWGstu.pjWGqlWt}) (generic transitive subject) and (\ref{ex:kuWGstuanW}) (\textsc{3pl}$\to$\textsc{1sg}).
...
\textsc{aor}-be.old-\textsc{1pl} be.good:\textsc{fact} \textsc{aor}-not.exist-\textsc{1pl} \textsc{lnk} \textsc{dem}.\textsc{prox} \textsc{aor}-be.like-\textsc{1pl} \textsc{lnk} \textsc{ipfv}:\textsc{downstream}-\textsc{inv}-drink.with.a.straw-\textsc{1pl} be.\textsc{aff}:\textsc{fact} \\
...
\textsc{ifr}.\textsc{ipfv}-snore \textsc{emph} \textsc{ifr}.\textsc{ipfv}-sleep be.\textsc{aff}:\textsc{fact} \textsc{lnk} at.all \textsc{emph}  \textsc{neg}-\textsc{ifr}-realize \\
...
\subsubsection{Continuity} \label{sec:svc.continuity}
The negative of the verb \japhug{prɤt}{break} as first member of a SVC (\ref{ex:amApWtWprAt}) can express continuity of the action (`without stopping').

\begin{exe}
 \ex \label{ex:amApWtWprAt}
 \gll a-mɤ-pɯ-tɯ-prɤt ʑo a-tɤ-tɯ-ndze \\
 \textsc{irr}-\textsc{neg}-\textsc{pfv}-2-break \textsc{emph} \textsc{irr}-\textsc{pfv}-2-eat[III] \\
 \glt `Don't stop taking (your medecine) !' (conversation, 2024/01/16)
\end{exe}

The irrealis verb form \ipa{a-mɤ-pɯ-tɯ-prɤt} in (\ref{ex:amApWtWprAt}) can be replaced by \forme{mɤ-kɯ-mbrɤt} `without stop, the negative impersonal infinitive of the anticausative \japhug{mbrɤt}{break} (see for instance \ref{ex:mAkWmbrAt.YWrAma}).
...
\textsc{dem} \textsc{genr}.\textsc{poss}-hand \textsc{inf}-release \textsc{neg}-\textsc{inf}:\textsc{stat}-be.needed \textsc{indef}.\textsc{poss}-water \textsc{erg} \textsc{ipfv}:\textsc{downstream}-\textsc{caus}-turn \textsc{pst}.\textsc{ipfv}-be.usually.the.case \\
...
girl-\textsc{dim} \textsc{pst}.\textsc{ipfv}-be.\textsc{aff}-\textsc{1sg} \textsc{lnk} \textsc{indef}.\textsc{poss}-son \textsc{pl} \textsc{3pl}.\textsc{poss}-\textsc{dat} \textsc{ipfv}-stay-\textsc{1sg} \textsc{neg}:\textsc{sens}-dare-\textsc{1sg} \textsc{lnk} \textsc{inf}-\textsc{refl}-\textsc{caus}-be.full \textsc{neg}-\textsc{pst}.\textsc{ipfv}-dare-\textsc{1sg} \\
...
\textsc{dem} \textsc{prohib}-\textsc{imp}-2-do.like[III] \textsc{dem}  \textsc{prohib}-\textsc{imp}-2-be.like \textsc{ipfv}-2-say-\textsc{pl} reason be:\textsc{fact} \textsc{sfp} \\
...
\textsc{1sg}.\textsc{poss}-son \textsc{3sg}.\textsc{poss}-\textsc{neg}-\textsc{ipfv}-\textsc{purp}:\textsc{conv}-catch.a.cold \textsc{indef}.\textsc{poss}-clothes \textsc{sbj}:\textsc{pcp}-be.thick \textsc{aor}-\textsc{caus}-wear-\textsc{pst}:\textsc{tr}-\textsc{1sg} \\
...
Gyalrong-language \textsc{inf}-learn \textsc{inf}-want.from  \textsc{erg}  \textsc{topo} until \textsc{aor}-come[II]-\textsc{1sg} be:\textsc{fact} \\
...
\textsc{sbj}:\textsc{pcp}-hunt \textsc{pl} \textsc{erg} \textsc{ipfv}-take-\textsc{pl} 3pl.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-help \textsc{ipfv}-take-\textsc{pl} \textsc{ifr}.\textsc{ipfv}-be.usually.the.case \\
...
\textsc{dem}:\textsc{pl} \textsc{erg} what \textsc{irr}-\textsc{pfv}-do.like-\textsc{pl} \textsc{lnk} \textsc{3pl}.\textsc{poss}-\textsc{indef}.\textsc{poss}-water exist:\textsc{sens} \\
...
\textsc{prohib}-\textsc{imp}-2-go \textsc{lnk} 2-\textsc{acaus}:cause.to.roll.down:\textsc{fact} \\
...
\gll nɯ kʰramba ma-tɤ-βze-a ra ma tɕe <lishijizai> pjɯ-tɯ-βze ɕti tɕetʰa, nɯnɯ rcanɯ <zuzubeibei> kɯ ɣɯ́-nɤmqe-a-nɯ.  \\
\textsc{dem}  lie \textsc{prohib}-\textsc{imp}-make[III]-\textsc{1sg} be.needed:\textsc{fact} \textsc{lnk} \textsc{lnk}   history.record \textsc{ipfv}-2-make[III] be.\textsc{aff}:\textsc{fact} later \textsc{dem} \textsc{unexp}:\textsc{deg} generations \textsc{erg}  \textsc{inv}-scold:\textsc{fact}-\textsc{1sg}-\textsc{pl} \\
...
bearded.vulture \textsc{dem} \textsc{1pl} \textsc{dem}.\textsc{prox}:\textsc{loc} \textsc{1pl}.\textsc{poss}-region \textsc{loc} exist:\textsc{fact} \textsc{lnk} \textsc{neg}-be.many:\textsc{fact} \\
...
\textsc{lnk} king \textsc{dem} \textsc{aor}-be.happy although \textsc{loc} \textsc{interj} \textsc{1sg}.\textsc{poss}-son \textsc{dem}.\textsc{prox} contest \textsc{indef} \textsc{neg}-\textsc{appr}-can \textsc{sfp} \textsc{ifr}-think \textsc{lnk} \\
...
\textsc{ifr}-2$\to$1-cheat-\textsc{1sg} \textsc{lnk} \textsc{dem} \textsc{sbj}:\textsc{pcp}-be.efficient \textsc{comp} instead \textsc{1sg}.\textsc{poss}-bottom \textsc{3sg}.\textsc{poss}-piece \textsc{aor}:3\flobv{}-\textsc{auto}-take.off \\
...
night \textsc{loc} star \textsc{dem} \textsc{aor}-marry \textsc{emph} \textsc{lnk} \textsc{genr}.\textsc{poss}-hair \textsc{ipfv}-\textsc{inv}-pull \textsc{lnk} \textsc{ipfv}-\textsc{sbj}:\textsc{pcp}-be.long not.exist:\textsc{sens} instead \textsc{sens}-hurt \textsc{sfp} \\
...
horse \textsc{comp} \textsc{sens}-be.big  \textsc{sens}-be.high  \textsc{comit} \textsc{sens}-be.big \\
\glt `It is larger than a horse. Bigger and larger.'  (19-rNamoN)
	\japhdoi{0003552\#S12}
\end{exe}
...
\textsc{3sg} \textsc{ifr}.\textsc{ipfv}-be.beautiful \textsc{advers} not.only \textsc{lnk} song also \textsc{ifr}.\textsc{ipfv}-be.expert \textsc{nmlz}:\textsc{action}-dance also \textsc{ifr}.\textsc{ipfv}-be.expert  \\
...
commerce \textsc{3sg}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-make \textsc{dem} \textsc{erg} apple \textsc{neg}-\textsc{ifr}-give not.only \textsc{lnk} \textsc{dem} \textsc{comp} \textsc{ifr}-scold \textsc{lnk} \textsc{ifr}-\textsc{caus}-go \\
...
\textsc{aor}-\textsc{obj}:\textsc{pcp}-bake \textsc{aor}-\textsc{obj}:\textsc{pcp}-cook  \textsc{sbj}:\textsc{pcp}-be.like \textsc{dem}:\textsc{pl} \textsc{neg}-eat[III]:\textsc{fact} apart.from \textsc{dem} \textsc{3sg}.\textsc{poss}-rest \textsc{dem} all \textsc{ipfv}-eat[III] be.\textsc{aff}:\textsc{fact} \\
...
\gll wortɕʰi wojɤr ʑo tɕʰimaʁnɤ a-ɣi ra nɯ-pʰe ɕɯ-rɤfɕɤt-tɕi (tsaʁ) ma tɕetʰa ɣɯ́-nɯzdɯɣ-a-nɯ \\
