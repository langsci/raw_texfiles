...
The intensifier \forme{wuma} is not restricted to adjectival stative verbs. It can be used with estimative verbs (§\ref{sec:estimative}) as in (\ref{ex:wuma.YWnAmNAm}), but also modal verbs such as \japhug{cʰa}{can} (§\ref{sec:cha.verb}) and action verbs that do not have an intrinsic degree parameter such as \japhug{ndza}{eat} (\ref{ex:wuma.Zo.ndze}).

\begin{exe}
\ex \label{ex:wuma.YWnAmNAm}
\gll  tɕe nɯ tɤ́-wɣ-tɕɤt tɕe nɯŋa nɯ kɯ wuma ɲɯ-nɤ-mŋɤm  \\
\textsc{lnk} \textsc{dem} \textsc{aor}-\textsc{inv}-take.out \textsc{lnk} cow \textsc{dem} \textsc{erg} really \textsc{sens}-\textsc{estim}-hurt  \\
...
\begin{exe}
	...
	\textsc{interj} \textsc{2sg} \textsc{unexp}:\textsc{deg} what \textsc{sens}-2-do[III] be:\textsc{fact} \textsc{lnk} \textsc{1sg} \textsc{indef}.\textsc{poss}-sky \textsc{erg} \textsc{aor}-2$\to$1-\textsc{caus}-wash-\textsc{1sg} cold \textsc{sfp} \\
...
\begin{exe}
	...
	\textsc{ifr}-\textsc{peg}-\textsc{recip}:scold-\textsc{du}-\textsc{peg} \textsc{lnk}  \textsc{unexp}:\textsc{deg} progressively \textsc{lnk}   \textsc{ifr}-\textsc{peg}-\textsc{recip}:take-\textsc{du}-\textsc{peg} \\
...
with \japhug{ma}{apart from} (§\ref{sec:exceptive}) containing counted nouns, to specify more precisely the difference in degree between the two referents as in (\ref{ex:RWpArme.ma.mAxtCi}).
...
\textit{Garrulax} \textsc{comp} \textsc{sens}-be.big a.little \\
\glt `It is a bit bigger than the \textit{Garrulax} sp.' (23-qapGAmtWmtW)
\japhdoi{0003608\#S12}
\end{exe}
...
\glll qaliaʁ nɯ ɯ-tɯ-wxti nɯ qandʑɣi cʰo \phantom{espace} naχtɕɯɣ tsa 	\\
...
garlic \textsc{3sg}.\textsc{poss}-leaf so.much \textsc{neg}-be.broad:\textsc{fact} \\
...
\textsc{dem} bear \textsc{dem} \textsc{erg} \textsc{filler} man \textsc{sens}-be.like \textsc{lnk} \textsc{filler} \textsc{filler} \textsc{dem} \textsc{indef}.\textsc{poss}-crops also \textsc{ipfv}-eat[III] meat also \textsc{ipfv}-eat[III] { } \textsc{sens}-be.usually.the.case \\
...
\begin{exe}
	...
	\textsc{inf}-cut  \textsc{3sg}.\textsc{poss}-\textsc{nmlz}:\textsc{deg}-easy \textsc{erg} \textsc{sens}-\textsc{denom}:\textsc{similative}-grass \textsc{emph} \\
...
\textsc{lnk} \textsc{indef}.\textsc{poss}-water \textsc{3sg}.\textsc{poss}-side \textsc{ipfv}-come.out \textsc{lnk} \textsc{dem} most \textsc{3sg}.\textsc{poss}-\textsc{obj}:\textsc{pcp}-\textsc{appl}-like be:\textsc{fact} \textsc{lnk} \\
...
\glt `The most beautiful of all birds is the peacock.' (24-ZmbrWpGa)
\japhdoi{0003628\#S79}
\end{exe}
...
\textsc{interj}:\textsc{surprise} \textsc{1sg}.\textsc{poss}-elder.sibling tiger \textsc{dem} why \textsc{prs}-2-\textsc{distr}:flee \textsc{lnk} \textsc{2sg}  \textsc{sbj}:\textsc{pcp}-be.like   \textsc{sbj}:\textsc{pcp}-\textsc{prop}-fear  not.exist:\textsc{fact} \\
