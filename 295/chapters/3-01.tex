...
\textsc{1sg}.\textsc{poss}-friend \textsc{indef} \textsc{cond}\redp{}2-be:\textsc{fact} \textsc{lnk} \textsc{1sg}.\textsc{poss}-horse \textsc{3sg}.\textsc{poss}-mane \textsc{3sg}.\textsc{poss}-on \textsc{imp}-land \textsc{1sg}.\textsc{poss}-enemy \textsc{indef} \textsc{cond}\redp{}2-be:\textsc{fact} \textsc{lnk} \textsc{1sg}.\textsc{poss}-horse \textsc{3sg}.\textsc{poss}-tail \textsc{3sg}.\textsc{poss}-on \textsc{imp}-land  \\
...
\textsc{indef}.\textsc{poss}-son \textsc{dem} \textsc{erg} \textsc{3sg}.\textsc{poss}-companion one-\textsc{cl} \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{ifr}-say one-\textsc{cl}  \textsc{dem} \textsc{erg} again \textsc{indef} \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{lnk}   \textsc{ifr}-\textsc{peg}-\textsc{recip}-\textsc{caus}-\textsc{recip}-hear-\textsc{pl} \\
...
When denominal verbs are derived from inalienably possessed nouns, the vocalism of the denominal prefix tends to be the same as that of the indefinite possessor prefix (for instance \japhug{tɤ-βɟu}{mattress} $\to$ \japhug{nɤβɟu}{use as a mattress}, not $\dagger$\forme{nɯβɟu}), though there are exceptions (\japhug{tɯ-rpaʁ}{shoulder} $\to$ \japhug{mɤrpaʁ}{carry on the shoulder}), as discussed in §\ref{sec:denom.mA}.
...
\textsc{interj} \textsc{dem} monkey \textsc{sbj}:\textsc{pcp}-\textsc{emph}\redp{}be.small \textsc{indef} \textsc{3sg}.\textsc{poss}-little.one \textsc{indef} \textsc{sens}-be.\textsc{aff} \\
...
\ex \label{ex:WtWci}
 ...
 but \textsc{3sg}.\textsc{poss}-\textsc{indef}.\textsc{poss}-water really \textsc{emph} \textsc{estim}-be.necessary:\textsc{fact} \textsc{lnk} \textsc{3sg}.\textsc{poss}-\textsc{indef}.\textsc{poss}-water \textsc{dem} \textsc{neg}-\textsc{ipfv}-\textsc{acaus}:break \textsc{sens}-be.needed \\
...
\ex \label{ex:Wmuj}
 ...
 nowadays \textsc{lnk} \textsc{3sg}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-kill completely not.exist:\textsc{sens} \textsc{lnk} \textsc{dem} eared.pheasant \textsc{3sg}.\textsc{poss}-feather also \textsc{genr}.\textsc{poss}-hand \textsc{neg}:\textsc{sens}-come \textsc{sfp} \\
 \glt `Nowadays, nobody kills them, and one cannot get eared pheasant feathers.' (23-qapGAmtWmtW)
...
The noun \japhug{tɤjmɤɣ}{mushroom} is alienably possessed, but the stem \forme{jmɤɣ-} appears as first element of compounds such as \japhug{jmɤɣni}{\textit{Russula} sp.}, suggesting that it was formerly inalienably possessed and occurred without its indefinite possessor prefix in this compound (see §\ref{sec:loss.possessive.prefix.compounds}). The status of \japhug{tɤjmɤɣ}{mushroom} as a former inalienably possessed noun is less surprising if one takes into account the likely etymological relationship with Chinese \zh{帽} \forme{mawH} `hat' (from \forme{*mˤuk-s}; etymology suggested by L. Sagart; see also the Tibetan cognate \tibet{རྨོག་}{rmog}{helmet}, \citealt{zhangsy19cognates}). If the noun for `mushroom' in Japhug and other Gyalrongic languages comes from `hat' (cf Breton \forme{tog touseg} `toad hat' for `mushroom'), it is expected that it would become an inalienably possessed noun (like \japhug{tɤ-rte}{hat}), and for the indefinite possessor \forme{tɤ-} to become frozen after the noun ceases to be a term for head covers.
...
\textsc{3sg}.\textsc{poss}-instruction \textsc{neg}-\textsc{sbj}:\textsc{pcp}-listen \textsc{3sg}.\textsc{poss}-sky \textsc{acaus}:take.off:\textsc{fact} \\
...
\textsc{2sg} \textsc{2sg}.\textsc{poss}-really \textsc{emph} \textsc{qu}-\textsc{ipfv}-2$\to$1-\textsc{appl}-like-\textsc{1sg} \textsc{lnk} \\
...
just.before \textsc{2sg}.\textsc{poss}-companion \textsc{dem} \textsc{aor}-kill-\textsc{1sg} be:\textsc{fact} \textsc{lnk} now \textsc{lnk} \textsc{2sg} \textsc{2sg}.\textsc{poss}-turn \textsc{ipfv}-1$\to$2-kill be.needed:\textsc{fact} \\
...
\textsc{dem} \textsc{sbj}:\textsc{pcp}-be.like \textsc{lnk} \textsc{genr} \textsc{genr}.\textsc{poss}-child also early \textsc{neg}-be.born:\textsc{fact} \textsc{ipfv}-say-\textsc{pl} \\
...
\textsc{genr}.\textsc{poss}-MB \textsc{3sg}.\textsc{poss}-offspring \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{lnk} \textsc{lnk} \textsc{1sg}.\textsc{poss}-MB \textsc{1sg}.\textsc{poss}-MZ \textsc{ipfv}-\textsc{genr}-say be:\textsc{fact} \\
...
\textsc{lnk} \textsc{genr}.\textsc{poss}-\textsc{dat} really \textsc{emph} \textsc{refl}-\textsc{caus}-be.near:\textsc{fact} \textsc{lnk} for.this.reason stupid:\textsc{fact} \textsc{ipfv}-say-\textsc{pl} \textsc{sens}-be \\
...
\textsc{lnk} \textsc{genr}.\textsc{poss}-mother \textsc{genr}.\textsc{poss}-father \textsc{pl} \textsc{genr}.\textsc{poss}-side \textsc{neg}:\textsc{sens}-stay-\textsc{pl} \textsc{lnk} \textsc{1sg} \textsc{1sg}.\textsc{poss}-grandmother \textsc{indef} \textsc{pst}.\textsc{ipfv}-exist \\ 
...
gold \textsc{indef}.\textsc{poss}-saddle \textsc{aor}:3\flobv{}-\textsc{auto}-put \textsc{sens}-be \\
...
\textsc{2sg}.\textsc{poss}-gold bowl \textsc{dem}:\textsc{pl} \textsc{ipfv}-2$\to$1-\textsc{caus}-use-\textsc{1sg} \\
...
\ex \label{ex:tshuBdWn.ri}
 ...
 \textsc{lnk} upstream \textsc{topo} \textsc{loc} \textsc{pst}.\textsc{ipfv}-stay-\textsc{1pl} \textsc{lnk} \\
...
\ex \label{ex:Dpalcan.XsWm}
 ...
 \textsc{irr}-\textsc{ipfv}-be \textsc{lnk} \textsc{anthr} two \textsc{dem} not.be:\textsc{fact} \textsc{lnk} three \textsc{sbj}:\textsc{pcp}-be.like \textsc{sbj}:\textsc{pcp}-be.identical together \textsc{irr}-\textsc{ipfv}-stay-\textsc{pl} \textsc{lnk} \textsc{anthr} \textsc{du} \textsc{anthr} \textsc{pl} \textsc{dem}:\textsc{pl} \textsc{ipfv}-\textsc{genr}-say be.possible:\textsc{fact} \\ 
...
\textsc{dem} before \textsc{3sg}.\textsc{poss}-husband \textsc{pst}.\textsc{ipfv}-\textsc{sbj}:\textsc{pcp}-be \textsc{anthr} \textsc{dem} \textsc{ifr}-see \\
\glt `She saw Tshering, who had been her husband before.' (2002 qajdoskAt)
...
The vowel \ipa{i} also alternates with \ipa{ɤ} in bound state, as in \japhug{qaprɤftsa}{millipede} from \japhug{qapri}{snake} and \japhug{tɤ-ftsa}{sister's child} or 
...
\japhug{ɴqiaβ}{dark side of the mountain} + \japhug{zwɤr}{mugwort} $\to$ \japhug{ɴqiazwɤr}{\textit{Artemisia} sp.} 
\item Loss of \ipa{-t}: 

\japhug{xtɯt}{be short} + \japhug{rɲɟi}{be long} $\to$ \japhug{xtɯrɲɟi}{length} (n)

 \japhug{tsʰɤt}{goat} + \japhug{ta-ʁrɯ}{horn} $\to$ \japhug{tsʰɤʁrɯ}{goat horn} 
\item Loss of \ipa{-z}: 

\japhug{qartsʰaz}{deer} + \japhug{tɯ-ndʐi}{skin} $\to$ \japhug{qartsʰɤndʐi}{deer hide} 
\item Loss of \ipa{-r}:

 \japhug{zwɤr}{mugwort} + \japhug{wɣrum}{be white} $\to$ \japhug{zwɤɣrum}{\textit{Artemisia} sp.} 

\japhug{ɕɤr}{night} + \japhug{ɯ-χcɤl}{center} $\to$ \japhug{ɕɤχcɤl}{middle of the night} 
\item Loss of \ipa{-ɣ}:

 \japhug{tɤjmɤɣ}{mushroom} + \japhug{--sti}{alone} $\to$ \japhug{jmɤtɤsti}{species of mushroom} 
 
\japhug{tɯ-mtʰɤɣ}{waist} + \japhug{rŋgɤβ}{attach} $\to$ \japhug{tɯ-mtʰɤrɴɢɤβ}{waistline of the trousers} (where one can tuck things in) 
\item Loss of \ipa{-ʁ}: 

\japhug{ɕoʁ}{buckwheat} + \japhug{wɣrum}{be white} $\to$ \japhug{ɕɤɣrum}{type of buckwheat} 

\japhug{paʁ}{pig} + \japhug{tɤ-qa}{paw, root} $\to$ \japhug{pɤqa}{stuffed pig feet} 
\end{itemize}
...
\is{possessive prefixes!loss}
In compounds with an inalienably possessed noun as final element, the indefinite possessor prefix is lost as a rule, as in for example in the plant name \japhug{kʰɯnajme}{\textit{Setaria viridis}} from \japhug{kʰɯna}{dog} and \japhug{tɤ-jme}{tail}.\footnote{The absence of the bound state \forme{kʰɯ-} is indicative in this case of a later loanword, perhaps calqued from Chinese \ch{狗尾草}{gǒuwěicǎo}{\textit{Setaria viridis}}. }

Exceptions are very few. They include compounds whose second element is itself a compound, such as \japhug{lɤndʐitɤlɤtsʰaʁ}{\textit{Delphinium} sp.} from \japhug{lɤndʐi}{ghost} and \japhug{tɤlɤtsʰaʁ}{milk filter}; the second element is from \japhug{tɤ-lu}{milk} in bound state and \japhug{tsʰaʁ}{sieve}. In \forme{lɤndʐi-tɤ-lɤ-tsʰaʁ} (ghost-\textsc{indef.poss}-milk-sieve), the indefinite possessor prefix \forme{tɤ-} has become frozen when the compound \japhug{tɤlɤtsʰaʁ}{milk filter} was formed, and is therefore not subject to deletion.
...
The noun \japhug{jmɤɣni}{\textit{Russula} sp.} clearly derives from \japhug{tɤjmɤɣ}{mushroom} and \japhug{ɣɯrni}{be red}, but while the loss of the \forme{tɤ-} prefix can be explained (see §\ref{sec:frozen.indef}), the form of the second element (without \forme{r-} preinitial) is a mystery. The form \forme{-rni} (without \forme{ɣɯ\trt}, a prefix possibly of denominal origin, §\ref{sec:denom.intr.GA}) is found in \japhug{qrorni}{red ant} with \japhug{qro}{ant} as first element. However, this form \forme{qro} for `ant' (instead of \forme{qroʁ-} as in other Japhug varieties) is borrowed from Tshobdun \forme{qrɔ}, suggesting that this compound may have been created recently.
...
Some compounds comprise elements that are themselves compounds. For instance, the first element \japhug{sɯŋgɯ}{forest} in \japhug{sɯŋgɯrmɤβja}{Himalayan monal} (with \japhug{rmɤβja}{peacock}) and \japhug{sɯŋgɯpɤjka}{type of wild squash} (with \japhug{pɤjka}{squash})
...
\textsc{3sg}.\textsc{poss}-on \textsc{3sg}.\textsc{poss}-new.twig also \textsc{sbj}:\textsc{pcp}-be.long \textsc{ipfv}:\textsc{up}-come.out \textsc{neg}:\textsc{sens}-can \textsc{lnk} \textsc{aor}-\textsc{obj}:\textsc{pcp}-cut \textsc{emph} \textsc{sens}-be.like \textsc{lnk} \textsc{dem} plant.name \textsc{ipfv}-\textsc{genr}-say be:\textsc{fact} \textsc{lnk} \textsc{dem} \textsc{3sg}.\textsc{poss}-head \textsc{sbj}:\textsc{pcp}-not.exist \textsc{inf}-say \textsc{sens}-be headless \textsc{dem} \textsc{3sg}.\textsc{poss}-head \textsc{sbj}:\textsc{pcp}-not.exist \textsc{inf}-say \textsc{sens}-be\\
...
The name \japhug{kʰɯlu}{\textit{Euphorbia helioscopia}} combines the reduced bound state of \japhug{kʰɯna}{dog} (§\ref{sec:reduced.forms.compounds}) with \japhug{tɤ-lu}{milk}. It presumably means `(having) dog milk', a reference to a whitish toxic liquid that comes from it (\ref{ex:khWlu}).
...
Another plant name, \japhug{qaprimdʑu}{\textit{Cicerbita roborowskii}}, from \japhug{qapri}{snake} and \japhug{tɯ-mdʑu}{tongue} is interpretable as a possessive compound `(having) a snake's tongue', referring to the shape of its leaves (\ref{ex:qaprimdZu}).
...
The compound \japhug{kɯngɯttɤrtsɤɣ}{\textit{Leonurus} sp.}, from the numeral \japhug{kɯngɯt}{nine} and the noun \japhug{tɤ-rtsɤɣ}{stairs}, can be analyzed as meaning `(plant having) nine stairs', referring to the nodes on the stalk of this plant. The Numeral-Noun order in this compound is remarkable, since numerals normally follow the noun (see §\ref{sec:uses.numerals}, §\ref{sec:noun.phrases.word.order}), but it is reminiscent of the order of some quantifiers  (§\ref{sec:quantifiers.determiners}). The same Numeral-Noun order is found in the more complex compound \japhug{kɯngɯttɤrqʰɤɴɢaʁ}{\textit{Lonicera} sp.} discussed in §\ref{sec.n.v.compounds}.
...
Action nominals built from two verb roots are not common in Japhug. Some of these action nominals are made from verbs with complementary or near-identical meanings, for instance \japhug{joʁβzɯr}{tidying up} from \japhug{joʁ}{raise} and \japhug{βzɯr}{move}. This noun occurs in a light verb construction as in (\ref{ex:joRBzWr}). The denominal compound verb \japhug{rɤjoʁβzɯr}{tidy up} has a meaning close to this construction (§\ref{sec:denom.compound.verbs}).
...
Second, the bird name \japhug{jaʁmɤzdoʁzdoʁ}{wren} contains the bound state form of \japhug{tɯ-jaʁmu}{thumb} and the pattern II ideophone \forme{zdoʁzdoʁ} meaning `small and active'.
...
Noun-Verb compounds include three main types, Subject-Verb, Object-Verb and Adjunct-Verb compounds. Participles or other nominalized verb forms are treated in sections \ref{sec.n.n.compounds}, but criteria to distinguish between ambiguous forms in cases of homophony between noun and verb are provided in §\ref{sec:object.verb.compounds}.
...
\japhug{pɣɤɲaʁ}{\textit{Pucrasia macrolopha}} & \japhug{pɣa}{bird} &  \\
...
The compounds in \tabref{tab:subj.v.compounds} are highly lexicalized; in the case for instance of \japhug{pɣɤɲaʁ}{\textit{Pucrasia macrolopha}}, this bird is not even black as the speakers themselves point out (\ref{ex:pGAYaR}).
...
\ex \label{ex:pGAYaR}
 ...
 \textit{Pucrasia\_macrolopha} \textsc{obj}:\textsc{pcp}-say \textsc{indef} exist:\textsc{fact} \textsc{lnk} \textsc{dem} \textsc{advers} of.course again \textsc{dem} bird be:\textsc{fact} but \textsc{neg}-be.black:\textsc{fact} \textsc{lnk} \textsc{sens}-be.beautiful \textsc{3sg}.\textsc{poss}-feather \textsc{dem}:\textsc{pl} really \textsc{emph}  \textsc{sens}-be.beautiful \textsc{lnk} \textsc{sbj}:\textsc{pcp}-exist \textsc{pl} \textsc{sens}-be.brilliant \textsc{emph} \\
...
\textsc{dem} \textsc{3sg}.\textsc{poss}-on \textsc{loc} praying.mantis \textsc{aor}-take-\textsc{1du} \textsc{lnk} .... \textsc{lnk} louse \textsc{unexp}:\textsc{deg} five.or.six about \textsc{emph} \textsc{3sg}.\textsc{poss}-\textsc{dat} \textsc{aor}:\textsc{east}-put-\textsc{1du} \textsc{lnk} \textsc{sbj}:\textsc{pcp}-be.first \textsc{dem}:\textsc{pl} \textsc{lnk} \textsc{lnk} louse \textsc{dem} \textsc{all} \textsc{emph} \textsc{ipfv}-swallow \textsc{lnk} \textsc{ipfv}-eat[III] \textsc{sens}-be \textsc{lnk} \textsc{sbj}:\textsc{pcp}-be.after \textsc{lnk} \textsc{dem}:\textsc{cataph} \textsc{sens}-be \textsc{lnk} \textsc{ipfv}-suck[III] \textsc{sbj}:\textsc{pcp}-be.like \textsc{lnk} \textsc{3sg}.\textsc{poss}-inside \textsc{dem} \textsc{3sg}.\textsc{poss}-blood \textsc{dem} \textsc{ipfv}:\textsc{upstream}-\textsc{auto}-take.out \textsc{lnk} \textsc{ipfv}-swallow \textsc{sens}-be \\
...
The incorporating denominal verbs \japhug{sɯzgrɯtɕʰɯ}{give a nudge} or \japhug{nɤkɤtɕʰɯ}{give a headbutt}, are considerably more common that light verb constructions with compound action nouns such as (\ref{ex:zgrWtChW}).

The compound \japhug{mɲaʁmtsaʁ}{\textit{Rhaphidophoridae}} from \japhug{tɯ-mɲaʁ}{eye} and \japhug{mtsaʁ}{jump} is obscure, but unlikely to be a possessive compound `whose eyes jump', and should rather be analyzed as an adjunct compound (maybe `jumping with (big) eyes', as if from a comitative adverb like \japhug{kɤ́mɲɯmɲaʁ}{with eyes} §\ref{sec:comitative.adverb}), or alternatively `jumping at one's eyes' (as suggested by Li Shang, p.c.). If any of these analyses is correct, \forme{mɲaʁmtsaʁ} is the only example of \textit{actor} Adjunct-Verb compound.
...
\japhug{qaɕɣi}{big fly} &	\japhug{qandʐi}{Sichuan taimen} \\
\japhug{qaɕpa}{frog} &	\japhug{qandʑɣi}{falcon} \\
\japhug{qajdo}{crow} &	\japhug{qaɲi}{zokor, \textit{Myospalax}} \\
\japhug{qajtʂʰa}{\textit{Aegypius monachus}} &	\japhug{qapar}{dhole} \\
\japhug{qajɯ}{worm} &	\japhug{qapɣɤmtɯmtɯ}{hoopoe} \\
\japhug{qaɟy}{fish} &	\japhug{qapri}{snake} \\
\japhug{qala}{rabbit} &	\japhug{qarma}{eared pheasant, \textit{Crossoptilon}} \\
...
The uvular prefix is however absent from many animal names, including nouns reconstructible to proto-Rgyalrongic such as \japhug{ca}{musk deer} \citep{laiyunfan25musk}. The presence or absence of this prefix on animal names is not predictable.
...
\japhug{kɯjka}{red-billed chough} \\
\japhug{kɯpɤz}{type of bug} \\
\japhug{kɯrtsɤɣ}{snow leopard} \\
\japhug{kɯrŋi}{beast} \\
\japhug{kɯrnɯ}{\textit{Dermestidae}} \\
 \lspbottomrule
\end{tabular}
\end{table} 
...
Some plant names have a uvular class prefix \forme{qa\trt}, including both cultivated and wild plants (and even plant parts), such as \japhug{qaɕti}{peach}, \japhug{qaɟɤɣi}{oat}, \japhug{qampʰoʁ}{oak leaves}, \japhug{qandzi}{type of fir}, \japhug{qaʑmbri}{\textit{Clematis} sp.}, \japhug{qawɯz}{edelweiss} and many others.
...
The noun \japhug{ʁejlu}{left-handed} is not a privative noun deriving from \japhug{ʁe}{left}, but rather a compound comprising the property noun \forme{ɯ-jlu} (§\ref{sec:property.nouns}) as second element, in its grammaticalized meaning as a restrictive focus marker (§\ref{sec:restrictive.focus}), literally meaning `only (with) left (hand)'.
 ...
 \subsection{Severed body part} \label{sec:severed}
\is{severed body part}
The prefix \forme{ɕɤ-} can be combined with the stem of body part nouns (removing the possessive prefixes) to form alienably possessed nouns expressing the part of an animal that has been severed from the body (Table \ref{tab:severed.CA}).  
 
\begin{table}
\caption{Severed body part \forme{ɕɤ-} prefix} \label{tab:severed.CA}
\begin{tabular}{Xll}
 \lsptoprule 
 Base Noun & Severed body part \\
 \midrule 
\japhug{tɯ-rna}{ear} &\japhug{ɕɤrna}{severed ear} \\
\japhug{tɯ-jaʁ}{hand, arm} &\japhug{ɕɤjaʁ}{meat of the anterior limbs} \\
\japhug{tɯ-ku}{head} &\japhug{ɕɤku}{severed head} \\
 \lspbottomrule
\end{tabular}
\end{table}

This prefix possibly originates from the bound state of the noun \japhug{ɕa}{raw meat} (from  Tibetan \tibet{ཤ་}{ɕa}{flesh}), though one would have expected for it to suffixed to the body part term, rather than prefixed.
...
just.before \textsc{dem} downstream \textsc{dem} \textsc{dem}.\textsc{prox} heddle downstream.one \textsc{dem}.\textsc{prox} \textsc{aor}-lift-\textsc{1sg} \textsc{pst}.\textsc{ipfv}-be \textsc{lnk} now \textsc{lnk} upstream.one \textsc{dem}.\textsc{pl} \textsc{ipfv}-\textsc{inv}-lift be.needed:\textsc{fact} \\
...
For some farm animals, a lexical distinction is made between male and female animals (see \tabref{tab:lexical.gender}). Some of these terms are reconstructible to proto-Rgyalrongic, an observation relevant to the history of yak domestication \citep{jacques21yak}.
...
\japhug{zraβ}{buck} & (\japhug{tsʰɤnmu}{nanny goat}) \\
 \lspbottomrule
\end{tabular}
\end{table}
...
\ex \label{ex:kAndZWftsWftsoR}
 ...
 \textsc{coll}-female.yak.hybrid three \textsc{dem} \textsc{idph}(II):in.order \textsc{sbj}:\textsc{pcp}-\textsc{aux} \textsc{aor}:\textsc{east}-\textsc{auto}-come.out-\textsc{pl} \textsc{sens}-be \\
...
\textsc{indef}.\textsc{poss}-water \textsc{3sg}.\textsc{poss}-inside worm:\textsc{coll} all forest \textsc{gen} animal \textsc{sbj}:\textsc{pcp}-be.small \textsc{sbj}:\textsc{pcp}-be.big yet bird \textsc{dem}:\textsc{pl} all \textsc{emph} \textsc{inf}-protect \textsc{inf}:\textsc{stat}-be.needed \textsc{sens}-be.\textsc{aff} \textsc{lnk} \\
...
\ex \label{ex:kWmAlAxso}
 ...
 \textsc{2pl} in.vain \textsc{sens}-2-be.\textsc{aff}-\textsc{pl} \textsc{lnk} 2-work:\textsc{fact}-\textsc{pl} not.exist:\textsc{sens} \\
...
ocean \textsc{3sg}.\textsc{poss}-bottom:\textsc{super} \textsc{ipfv}:\textsc{down}-go \textsc{lnk} \textsc{dem} \textsc{3sg}.\textsc{poss}-\textsc{obj}:\textsc{pcp}-\textsc{estim}-be.tasty \textsc{dem}:\textsc{pl} \textsc{tral}-\textsc{ipfv}-\textsc{auto}-take.out \textsc{sens}-be \\
...
\textsc{3sg}.\textsc{poss}-\textsc{nmlz}:\textsc{deg}-\textsc{denom}-thorn be.extremely:\textsc{fact} \\
...
\textsc{comit}-hat \textsc{emph} house \textsc{3sg}.\textsc{poss}-inside \textsc{aor}-2-come[II] \\
...
\textsc{lnk} basket \textsc{indef} \textsc{comit}-thread \textsc{indef} \textsc{ifr}-borrow \\
\glt `He borrowed a backpack with a thread.' (140427 qala cho kWrtsAG) \japhdoi{0003852\#S56}
\end{exe}
\is{comitative adverb}
...
alcohol \textsc{pl} \textsc{perlative}\redp{}path \textsc{ipfv}-\textsc{inv}-\textsc{auto}-drink \textsc{lnk} \\
