...
In Kalmyk, the marker \textit{bišǝ} is less frequent than the negative copula uga, as shown in \tabref{tab:BK1}. The frequency of the negative affix \textit{-šǝ}, in turn, is also lower than the affix \textit{-go}.
