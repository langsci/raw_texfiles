...
\markuptitle{Extensions and commonalities in negative existential cycles in Arabic}{Extensions and commonalities in negative existential cycles in Arabic}

\shorttitlerunninghead{Extensions and commonalities in negative existential cycles in Arabic}

\renewcommand{\lsCollectionPaperFooterTitle}{Extensions and commonalities in negative existential cycles in Arabic}
...
\footnotetext{The \textit{laysa} cycle is examined in much greater detail in \citet{wilmsen2016a}.}
\ea \label{ex:WiAR-1}
...
\footnotetext{The \textit{šī} cycle is examined at greater length in \citet{wilmsen2020a}.}
...
\footnotetext{The \textit{bī} cycle is addressed in greater detail in \citet{wilmsen2020b}.}
