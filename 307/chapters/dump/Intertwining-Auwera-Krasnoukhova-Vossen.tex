...
together in a model of a generalized Jespersen Cycle. \sectref{sec:int-6}
...
shown in \REF{ex:int-qc-latin}. %\sectref{sec:int-7} is the conclusion.
\todo{\sectref{sec:int-6} is conclusion and there is no §7}
...
% \todo{missing data: Vossen \& van der Auwera 2014 (in footnote)} %
%
Jespersen did not
...
\REF{ex:int-tewa-man}\todo{should this refer to \REF{ex:int-finnish-kahvi}?} has a negative auxiliary and the so-called ``connegative'',
...
omitted.}%\todoref{viite: Guillaume tässä teoksessa} %
%
...
\REF{ex:int-meithei-cloth}.%\todo{missing data: Chelliah 1971}

\begin{exe}\ex Meithei [mni]
\langinfo{}{Tibeto-Burman}{\citealt[297]{Chelliah1971}}
\begin{xlist}
...
of \REF{ex:int-canadian-town}.\todo{is this a new paragraph starting with this sentence?}
%
\begin{figure}
