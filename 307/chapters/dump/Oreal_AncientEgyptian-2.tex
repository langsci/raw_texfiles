...
%Ljuba updated this version on April 26, May 15, May 17 2021. Please use in book.

\author{Elsa Oréal\affiliation{French National Centre for Scientific Research}} 

\markuptitle{The negative existential cycle in Ancient Egyptian}{The negative existential cycle in Ancient Egyptian}
...
\textbf{Keywords:} {Ancient Egyptian, Negative Existential Cycle, Grammaticalization, Nominalization}
...
\z \todo{Please re-check alignment}
...
In both cases, there are good reasons to assume that the special paradigm of forms attested in the construction had acquired its modal semantics as a complement of manipulative verbs such as \textit{rDi} \todo{the D should be d with a line under it}‘to let/allow’.\footnote{On the use in main clauses of verb forms whose modal semantics emerge from their primary use in completive clauses, see Evans (2007) and the notion of insubordination, whose applicability to the Egyptian tense sometimes called ‘Subjunctive’ still needs further research. }  
...
\z \todo{Re-check alignment. See Elsa's pdf}
