...
\begin{sidewaystable}[]
    ...
    \begin{tabular}[c]{@{}l@{}}\textbf{synthetic form} 			\\ e.g., \textit{sā-ra-sị}\\ know-\textsc{conneg-neg.prs}\end{tabular} & yes & yes & yes & yes & yes & yes & yes & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{negative verb + V-CONNEG}		\\ e.g., \textit{e-si-ni ŋennee}\\ \textsc{neg.aux-prs-3sg} go.\textsc{conneg}\end{tabular} & no & no & no & no & no & no & no & yes \\ \midrule
    \multicolumn{9}{l}{\textbf{PAST}} \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{əčiə(l) V-CONNEG}	\\ e.g., \textit{əčiə bu-də-ni}\\ \textsc{neg.pst.cop} die-\textsc{conneg-3sg}\end{tabular} & yes & yes (‘not yet’) & no & marginal & yes & no & (‘not yet’) & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{synthetic form}	\\ e.g., \textit{sa-o-rā-čin}\\ know-\textsc{imps-conneg-pst}\end{tabular} & yes & yes & yes & no & yes & yes & no & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{negative verb + V-CONNEG}\\ e.g., \textit{ec-ci-ni ŋennee}\\ \textsc{neg.aux-pst-3sg} go.\textsc{conneg}\end{tabular} & no & no & no & no & no & no & no & yes \\ \lspbottomrule
    \end{tabular}
\end{sidewaystable}
...
\begin{sidewaystable}[]
    ...
    \begin{tabular}{@{}lllll@{}}
        ...
        \begin{tabular}[c]{@{}l@{}}past 	tense negators in\\ competition with\\ CVB.SIM + NegEx\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textit{əčə} V-CONNEG,\\ V-PST NegEx,\\ synthetic form\end{tabular} & (\textit{əčiə} V-CONNEG) & \begin{tabular}[c]{@{}l@{}}\textit{əčiə} V-CONNEG,\\ synthetic form\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textit{əčəl} 	V-CONNEG,\\ V-PST NegEx,\\ \textit{əŋdə} V-CONNEG\end{tabular} \\
...
\todo{solve issue with alignment}
...
Such a path of evolution implies that the negative existential does not enter into the SN-system directly, but through the use in the no-answer or pro-sentence function (the same assumption was proposed for Bikin Nanai above, for Sino-Russian pidgin in \citet[155-156]{Veselinova2016}, for Palenquero, a Spanish-based creole, in \citet[21]{Croft1991}, who cites \citet{Schwegler1988}, and for Swahili varieties in Bernander et al. (this volume)\todo{internal ref}).
...
\begin{table}[]
    ...
    \begin{tabular}{@{}llll@{}}
        ...
        Kur-Urmi & \textit{aba} & \begin{tabular}[c]{@{}l@{}}one of the main\\ past tense\\ sn-negators\end{tabular} & \textsc{pst/prs} \textit{aba} \\
