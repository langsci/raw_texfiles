...
%This is the final version. Ljuba checked the changes requested by the authors on January 11.
...
\resizebox{0.9\textwidth}{!}{
    \begin{tabular}{lllllll}
        a. & Researcher & \multicolumn{5}{l}{} \\
         ...
         & Naikhin Nanai): & \textit{N’oani} & \textit{bičxə-wə} & \textit{əčiə} & \multicolumn{2}{l}{\textit{niru-ə-ni.}} \\
         &  & \textsc{3sg} & letter-\textsc{acc} & \textsc{neg.pst} & \multicolumn{2}{l}{write-\textsc{cng-3sg}} \\
        b. & Researcher: & \multicolumn{5}{l}{Is it a correct Nanai sentence:} \\
         &  & \textit{N’oani} & \textit{bičxə-wə} & \textit{niru-mi} & \multicolumn{2}{l}{\textit{aba.}} \\
        ...
        c. & Researcher: & \multicolumn{5}{l}{Is it a correct Nanai expression:} \\
         &  & \multicolumn{2}{l}{\textit{niru-m=də}} & \multicolumn{3}{l}{\textit{aba?}} \\
         ...
         & Speaker: & \textit{N’oani} & \textit{bičxə-wə} & \textit{niru-m=də} & \multicolumn{2}{l}{\textit{aba.}} \\
...
\ea Naikhin Nanai \label{ex:T4}\\
	...
	\textsc{proh}	believe-\tedxtsc{imp}-\textsc{imp.2pl}	\textsc{neg.pst.cop}	die-\textsc{conneg-3sg=quot}\\
...
\begin{sidewaystable}[]
    ...
    \begin{tabular}[c]{@{}l@{}}\textbf{synthetic form} 			\\ e.g., \textit{sā-ra-sị}\\ know-\textsc{cng-neg.prs}\end{tabular} & yes & yes & yes & yes & yes & yes & yes & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{negative verb + \tedxtsc{v-cng}}		\\ e.g., \textit{e-si-ni ŋennee}\\ \textsc{neg.aux-prs-3sg} go.\textsc{cng}\end{tabular} & no & no & no & no & no & no & no & yes \\ \midrule
    \multicolumn{9}{l}{\textbf{PAST}} \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{əčiə(l) \tedxtsc{v-cng}}	\\ e.g., \textit{əčiə bu-də-ni}\\ \textsc{neg.pst.cop} die-\textsc{cng-3sg}\end{tabular} & yes & yes (‘not yet’) & no & marginal & yes & no & (‘not yet’) & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{synthetic form}	\\ e.g., \textit{sa-o-rā-čin}\\ know-\textsc{imps-cng-pst}\end{tabular} & yes & yes & yes & no & yes & yes & no & no \\ \midrule
    \begin{tabular}[c]{@{}l@{}}\textbf{negative verb + \tedxtsc{v-cng}}\\ e.g., \textit{ec-ci-ni ŋennee}\\ \textsc{neg.aux-pst-3sg} go.\textsc{cng}\end{tabular} & no & no & no & no & no & no & no & yes \\ \lspbottomrule
    \end{tabular}
\end{sidewaystable}
...
\begin{table}[]
    ...
    \begin{tabular}{@{}lll@{}}
        \lsptoprule
        function name & short description & aba \\ \midrule
...
\begin{table}[!h]
    ...
    %if shadowing is not allowed, bold is also an option
...
\begin{sidewaystable}[]
    ...
    \begin{tabular}{@{}lllll@{}}
        ...
        \begin{tabular}[c]{@{}l@{}}past 	tense negators in\\ competition with\\ CVB.SIM + NegEx\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textit{əčə} \tedxtsc{v-cng},\\ \tedxtsc{v-pst NegEx},\\ synthetic form\end{tabular} & (\textit{əčiə} \tedxtsc{v-cng}) & \begin{tabular}[c]{@{}l@{}}\textit{əčiə} \tedxtsc{v-cng},\\ synthetic form\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textit{əčəl} \tedxtsc{v-cng},\\ \tedxtsc{v-pst NegEx},\\ \textit{əŋdə} \tedxtsc{v-cng}\end{tabular} \\
...
\begin{exe}
    ...
    % I don't see the compiled version but the authors state that analytic forms should be aligned with neg1+neg2
\end{exe}
...
\begin{table}[]
    ...
    \begin{tabular}{@{}llll@{}}
        ...
        \begin{tabular}[c]{@{}l@{}}Gorin\\ Nanai\\ (Amur)\end{tabular} & \textit{kəukə} & n/a & n/a \\
        ...
        Ulch & \textit{kəwə} & \begin{tabular}[c]{@{}l@{}}default past tense\\ SN-negator\end{tabular} & PST/PRS \textit{kəwə} \\ \bottomrule
    \end{tabular}
    \end{table}
...
\begin{figure}[!h] \todo{Please make sure the map has landscape orientation and takes an entire page}
