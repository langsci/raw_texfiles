...
Tacana\il{Tacana|(} is one of the five extant languages of the small Takanan family from
...
\cites{Schwegler1988}[49]{Auwera2009-tac}[127ff]{Veselinova2013-tac}[155--156]{Veselinova2016}).
...
(5) non-clausal \textbf{constituent negation} with two subtypes (\sectref{sec:tacana-7}); and
(6) \textbf{negation of command (hortative and imperative) clauses} with
two subtypes (\sectref{sec:tacana-8}).%
%
...
%
ergative
case-marking system, as illustrated in \REF{ex:tacana-monkey-sun}, with an ergative
...
Unless explicitely specified, the examples come from texts.}\todo{this
footnote has one odd closing paren} 
%
%\let\eachwordone\glossfont
%\renewcommand{\eachwordtwo}{\exfont}
%\let\eachwordthree\glossfont
...
\begin{xlist}\ex\label{ex:tacana-monkey-sun}
  ...
  \gll Jiawe  =da
\overnote{O}id'eti
\overnote{A}biwa\textbf{=ja}
\overnote{V}y-abu-ta-{\op}a{\cp}ni.\\
...
\end{xlist}\end{exe}\todo{which formatting is better,
\REF{ex:tacana-monkey-sun} or \REF{ex:tacana-monkey-branch}?}%
%
...
\REF{ex:tacana-monkey-sun-branch}, and a \textbf{non-finite verb
...
%
    ...
    consecutive sentences from the same text in \REF{ex:tacana-going-to-let-go}. I
...
\ex\label{ex:tacana-going-to-spill}
  \gll Dapia  =da  \overnote{A}etse  beu
  \overnote{O}se
  \overnote{V}\textbf{\underline{e}}-tutua.\\
...
\ex\label{ex:tacana-let-go}
  \gll Beu  =pa
  \overnote{V}ja-mesia-ti-\textbf{\underline{idha}}
  jida  \overnote{S}deja, mawi
  echa=jenetia.\\
    \textsc{ptc}  =\textsc{rep}
...
\gll \textbf{Aimue}
\overnote{O}ejije=kwana
\overnote{A}yama
\overnote{V}\textbf{\underline{e}}-shanapa-eni-\textbf{\underline{inia}}=\textbf{mawe}.\\
...
\gll  \textbf{Aimue}  =da
\overnote{S}ema
\overnote{V}\textbf{\underline{e}}-siapati-yu=\textbf{mue}.\\
...
\gll  Jade,  \overnote{A}{\ob}ye=base=ja{\cb}  =mu  \textbf{aimue},  sai-da
  \overnote{V}\textbf{\underline{y}}-a-\textbf{\underline{ta-ani}}=\textbf{mawe}.\\
...
\overnote{V}jadusuti-\textbf{\underline{ina}}=\textbf{mawe}.\\
...
\gll \textbf{Aimue}
\overnote{V}\textbf{\underline{e}}-juseute-\textbf{\underline{ta}=}\textbf{mawe},
\overnote{A}beni=ja.\\
...
\overnote{V}\textbf{\underline{e}}-kwinana\textbf{=mawe},
\overnote{S}dukei.\\
...
\gll 
    \overnote{S}{\ob}Tueda edeje{\cb}
    \overnote{NP}{\ob}a'una deja{\cb}  
    \overnote{COP}pu-ina.\\
...
\gll \overnote{S}{\ob}Mike ebakepuna{\cb}
\overnote{NP}{\ob}kema kwara{\cb}.\\
...
\gll
    \overnote{S}Id'eti  =di
    \overnote{ADJ}tuche-da
    \overnote{COP}e-pu-eti.\\
...
\gll \overnote{S}Te  =mu
\overnote{ADJ}ai-da  beju…\\
...
\gll
  \overnote{S}{\ob}Tueda  edeje{\cb}
  \textbf{aimawe}  \overnote{NP}{\ob}kristianu
  eni{\cb}
  \overnote{COP}pu-ina=\textbf{mawe}.\\
...
\gll \overnote{S}{\ob}Kea tata{\cb} =mu
\textbf{aimue}  \overnote{ADJ}sai-da
\overnote{COP}pu-ina=\textbf{mawe}.\\
...
\gll 
    \textbf{Aimue}
    \overnote{ADJ}sai-da=\textbf{mawe}
    \overnote{S}{\ob}mike e-bakwa{\cb}.\\
...
clauses, whether\todo{can't hyphenate the word \textit{whether}!}{} affirmative or negative. In affirmative existential and
...
\gll \overnote{LOC}Chue
\overnote{LOC}{\ob}enabaki maje=su{\cb}
\overnote{V}\textbf{y-ani}.\\
...
\gll \overnote{S}{\ob}Beinte familia{\cb}
\overnote{V}\textbf{ani-ina}
\overnote{LOC}Napashi=su {\ob}da
mara=su{\cb}.\\
...
\gll \overnote{S}Juishu  beju
\overnote{V}\textbf{pu-iti-a}.\\
...
\gll  \overnote{S}Tueda
\overnote{LOC}escuela=su
\overnote{V}\textbf{pu-ina}.\\
...
\gll \textbf{Aimue} \overnote{V}ani-iti-a\textbf{=mawe}
\overnote{S}Rurrenabaque.\\
...
\gll \overnote{S}Kwati  =mu
\overnote{ADJ}\textbf{aimue}  =tsu'u.\\
...
\gll \overnote{ADJ}\textbf{Aimue}  beu \overnote{S}se.
\overnote{ADJ}\textbf{Aimue}  beu.\\
...
\gll 
  \overnote{S}Ema  =mu \overnote{ADJ}\textbf{aimawe}  beu
...
\gll 
  \overnote{ADJ}\textbf{Aimue} \overnote{DAT}mesa \overnote{S}aicha…\\
...
\gll  \textbf{Aimue}  beu,
\overnote{V}\textbf{kwinana-yu}
\overnote{AUX}\textbf{pu-idha.}\\
...
\gll  \textbf{Aimue}  \overnote{A}yama
\overnote{O}d'aki
\overnote{V}\textbf{ba}.\\
...
\gll  \textbf{Aimue},  \overnote{S}ema
\overnote{V}\textbf{kwinana-puda}.\\
...
\textit{beu}
\overnote{V}\textbf{\textit{ja-tibi-ti}}.\\
...
\gll  \textbf{Mué=}pa
\overnote{V}\textbf{teje-ti-yu}
\overnote{AUX}\textbf{a-ta-idha}
...
negation and constituent negation. \textbf{Stand-alone negation} is
...
\glt   `No, no voy a ir.' su028\\
  (`Do you want to go to Mass with us?') `\underline{No}! I
  wo\underline{n't} go!'}
%
...
\gll
\overnote{S}Tueda \overnote{ADJ}sai-da\textbf{=mawe},
\overnote{S}ema =mu \overnote{ADJ}sai-da=kita.\\
...
\gll
\overnote{O}Tueda \overnote{V}\textbf{pa}-dia-ta \overnote{A}señora=ja,
...
\gll
\overnote{A}Tueda =mu \textbf{be} \overnote{V}\textbf{pa}-dia-ta
\overnote{O}{\ob}jida aicha{\cb}!\\
...
The following table\todo{had to make some changes to make this table fit
the page; it won't fit right below this paragraph}{} summarizes all the negation constructions described
...
negator.\todo{shading is not allowed}{} 
%
...
\ex
\gll
  \overnote{NEG}\textbf{Mave} \overnote{V}\textbf{chanapa} cuaja
  miada ema e-ba-nia.\\
...
\section*{List of non-standard abbreviations}\todo{this section title
should rather be simple ``Abbreviations''; additional information may be
given in body text}%
%
