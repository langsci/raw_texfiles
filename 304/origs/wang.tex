...
\newenvironment{stylecaption}{\setlength\leftskip{0cm}\setlength\rightskip{0cm plus 1fil}\setlength\parindent{0cm}\setlength\parfillskip{0pt plus 1fil}\setlength\parskip{0in plus 1pt}\writerlistparindent\writerlistleftskip\leavevmode\normalfont\normalsize\fontsize{9pt}{10.8pt}\selectfont\bfseries\writerlistlabel\ignorespaces}{\unskip\vspace{0.139in plus 0.0139in}\par}
...
\newcommand\labellistWWNumxivleveli{\thelistWWNumxivleveli.}
\newcommand\labellistWWNumxivlevelii{\thelistWWNumxivlevelii.}
\newcommand\labellistWWNumxivleveliii{\thelistWWNumxivleveliii.}
\newcommand\labellistWWNumxivleveliv{\thelistWWNumxivleveliv.}
\newenvironment{listWWNumxivleveli}{\def\writerlistleftskip{\setlength\leftskip{0.278in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.278in}}\def\writerlistlabel{\stepcounter{listWWNumxivleveli}\makebox[0cm][l]{\labellistWWNumxivleveli}\hspace{0.0cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxivlevelii}{\def\writerlistleftskip{\setlength\leftskip{0.5in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.5in}}\def\writerlistlabel{\stepcounter{listWWNumxivlevelii}\makebox[0cm][l]{\labellistWWNumxivlevelii}\hspace{0.0cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxivleveliii}{\def\writerlistleftskip{\setlength\leftskip{0.75in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.75in}}\def\writerlistlabel{\stepcounter{listWWNumxivleveliii}\makebox[0cm][l]{\labellistWWNumxivleveliii}\hspace{0.0cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxivleveliv}{\def\writerlistleftskip{\setlength\leftskip{0.75in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.75in}}\def\writerlistlabel{\stepcounter{listWWNumxivleveliv}\makebox[0cm][l]{\labellistWWNumxivleveliv}\hspace{0.0cm}\writerlistremovelabel}}}{}
...
\newenvironment{listWWNumxxixleveli}{\def\writerlistleftskip{\setlength\leftskip{0.5in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxixleveli}\makebox[0cm][l]{\labellistWWNumxxixleveli}\hspace{-0.635cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxixlevelii}{\def\writerlistleftskip{\setlength\leftskip{1in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxixlevelii}\makebox[0cm][l]{\labellistWWNumxxixlevelii}\hspace{-1.905cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxixleveliii}{\def\writerlistleftskip{\setlength\leftskip{1.5in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.1252in}}\def\writerlistlabel{\stepcounter{listWWNumxxixleveliii}\makebox[0cm][r]{\labellistWWNumxxixleveliii}\hspace{-3.4919918cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxixleveliv}{\def\writerlistleftskip{\setlength\leftskip{2in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxixleveliv}\makebox[0cm][l]{\labellistWWNumxxixleveliv}\hspace{-4.4449997cm}\writerlistremovelabel}}}{}
...
\renewcommand\thelistWWNumxxvileveli{}
...
\hline
\multicolumn{2}{m{4.64066in}|}{\textbf{Process}}\\\hline
Material &
...
\multicolumn{2}{m{4.64066in}|}{\textbf{Circumstance}}\\\hline
Location &
...
\multicolumn{2}{m{4.64066in}|}{\textbf{Participant}}\\\hline
Attribute &
...
\hline
 &
\multicolumn{3}{m{2.0219598in}}{\centering Student corpus} &
\multicolumn{3}{m{2.0219598in}}{\centering Expert corpus}\\\hhline{~------}
 &
Ideational &
Textual &
Interpersonal &
...
\hline
 &
 &
\multicolumn{2}{m{0.7789598in}}{Student corpus} &
\multicolumn{2}{m{0.7782598in}}{Expert corpus} &
\\\hline
Categories &
Sub-categories &
No. &
