main.snd:
	...
	sed -i 's/.*\(Office\|Team\|Bureau\|Organisation\|Organization\|Embassy\|Association\|Commission\|committee\|government\|Agency\|Statistic\|Alþingi\|EDUFI\|Ministry\|OECD\|Inspectorate\|Group\|UNAK\|University´\).*//' main.adx
