...
\noteseealso{itwáŋítésúƙot{\higha}}%
%------------------------------
\newentry
...
\definition{class, grade, level (in schol)}%
...
\note{An expression borrowed from Ateker (Teso-Turkana).}%
%------------------------------
\newentry
...
\definition{to be expanded, widened (e.g. a road)}%
...
\note{The one who experiences this sensation takes the \isi{dative} case in a sentence.}%
%------------------------------
\newentry
...
\definition{to meet a member of the opposite \isi{gender} in the middle of a dance circle during a group dance}%
...
\definition{to look around cautiously (e.g. so as to avoid enemies or encounters with one's mother-in-law)}%
...
\definition{to feel sexual afterglow (after an orgasm)}%
...
\note{The object acquired takes the \isi{dative} case.}%
%------------------------------
\newentry
...
\note{Must be followed by another verb in the \isi{infinitive}.}%
%------------------------------
\newentry
...
\definition{sun watcher: an elder who is an expert in observing the seasonal cycle of the sun's rising and setting}%
\glosses{sun watcher}%
%------------------------------
\newentry
...
\note{Must be followed by an \isi{infinitive} in the \isi{dative} case.}%
%------------------------------
\newentry
