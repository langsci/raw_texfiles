...
Eight examples are given above because Icétôd has eight cases: nominative, accusative, \isi{dative}, genitive, ablative, instrumental, copulative, and oblique. \tabref{tab:case:suffixes} presents the non-final and final forms of the suffixes that mark all eight of these cases. Keep in mind that the null symbol <Ø> signifies either 1) that the case suffix is inaudible or, for the \isi{oblique case}, 2) that there is no case suffix:
