...
\begin{tabular}{lrrr}
  ...
  1st token mean nuc \isi{F2} (Bark) & 11.25  & 11.19 & 11.23 \\
  2nd token mean nuc \isi{F2} (Bark) & 11.49 & 11.45 & 11.47 \\
  mean nuc \isi{F2} diff. (Bark) & -0.2379 & -0.2554  & -0.2458 \\
...
\begin{tabular}{lrrr}
  ...
  1st token mean nuc \isi{F2} (Bark) & 11.610 & 11.680 & 11.640 \\
  2nd token mean nuc \isi{F2} (Bark) & 11.180  & 11.150 & 11.170 \\
  mean nuc \isi{F2} diff. (Bark) &  0.4210 & 0.5324 & 0.4718 \\
...
\begin{tabular}{lrrr}
  ...
  1st token mean nuc \isi{F2} (Bark) & 11.59  & 11.60 & 11.59 \\
  2nd token mean nuc \isi{F2} (Bark) &  11.57 & 11.65 & 11.61 \\
  mean nuc \isi{F2} diff. (Bark) & 0.01299 & -0.04582 & -0.01355 \\
...
\begin{tabular}{lrrr}
  ...
  1st token mean nuc \isi{F2} (Bark) &  11.45  & 11.44 & 11.44 \\
  2nd token mean nuc \isi{F2} (Bark) &  11.37 &  11.38 & 11.37 \\
  mean nuc \isi{F2} diff. (Bark) &  0.08333  & 0.05636  & 0.07130 \\
...
\begin{tabular}{lrrr}
  ...
  1st token mean nuc \isi{F2} (Bark) &  11.45  & 11.47  & 11.46  \\
  2nd token mean nuc \isi{F2} (Bark) &  11.54 & 11.48 & 11.51 \\
  mean nuc \isi{F2} diff. (Bark) &  -0.08344  & -0.01363 & -0.05178 \\
...
\end{table}	
 ...
 % 1st token monoph, 2nd token \isi{diphthong} & 54 & 59 & 
 % 1st token \isi{diphthong}, 2nd token monoph & 57 & 66 & 
