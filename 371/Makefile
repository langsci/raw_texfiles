...
main.snd: main.bbl
	...
	sed -i 's/.*Universität*//' main.adx
	sed -i 's/.*ALPAC*//' main.adx
	sed -i 's/.*IBM.*//' main.adx
	sed -i 's/.*Congree.*//' main.adx
	sed -i 's/.*DeepL.*//' main.adx
	sed -i 's/.*Gesellschaft.*//' main.adx
	sed -i 's/.*ISO.*//' main.adx
	sed -i 's/.*LDC.*//' main.adx
	sed -i 's/.*Statista.*//' main.adx
	sed -i 's/.*TAUS.*//' main.adx
	sed -i 's/.*tekom.*//' main.adx
