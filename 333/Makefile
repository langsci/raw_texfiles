...
main.snd: main.bbl
	...
	sed -i 's/.*Technic.*//' main.adx
	sed -i 's/.*Career.*//' main.adx
	sed -i 's/.*ABRACE.*//' main.adx
	sed -i 's/.*Ministerio.*//' main.adx
	sed -i 's/.*Department.*//' main.adx
	sed -i 's/.*NCTE.*//' main.adx
	sed -i 's/.*Council.*//' main.adx
	sed -i 's/.*Institute.*//' main.adx
	sed -i 's/.*Instituto.*//' main.adx
	sed -i 's/.*Coalition.*//' main.adx
