...
main.snd: main.bbl
	...
	sed -i 's/RRG/Role and Reference Grammar/' main.sdx
	sed -i 's/QUD/Question Under Discussion/' main.sdx
	sed -i 's/HNP|/Hic et Nunc Particle|/' main.sdx
	sed -i 's/Hic et Nunc Particles/Hic et Nunc Particle/' main.sdx
	sed -i 's/HNPs/Hic et Nunc Particle/' main.sdx
	sed -i 's/reference types|/reference type|/' main.sdx
	sed -i 's/HPSG/Head-driven Phrase Structure Grammar/' main.sdx
	sed -i 's/TAG/Tree Adjoining Grammar/' main.sdx
	sed -i 's/TWG/Tree-Wrapping Grammar/' main.sdx
	sed -i 's/anaphora/anaphor/' main.sdx
	sed -i 's/ARDs/assertive rising declaratives/' main.sdx
	sed -i 's/ARD|/assertive rising declaratives|/' main.sdx
	sed -i 's/Assertive rising declaratives|/assertive rising declaratives|/' main.sdx
	sed -i 's/classifiers/classifier/' main.sdx
	sed -i 's/DGB|/dialogue game board|/' main.sdx
	sed -i 's/DGBs/dialogue game board/' main.sdx
	sed -i 's/DM|/discourse marker|/' main.sdx
	sed -i 's/DMs/discourse marker/' main.sdx
	sed -i 's/DR|/discourse relations|/' main.sdx
	sed -i 's/DRs/discourse relations/' main.sdx
	sed -i 's/discourse relation|/discourse relations|/' main.sdx
	sed -i 's/IRDs/inquisitive rising declaratives/' main.sdx
	sed -i 's/Inquisitive rising declaratives|/inquisitive rising declaratives|/' main.sdx
	sed -i 's/IRD|/inquisitive rising declaratives|/' main.sdx
	sed -i 's/logophoric|/logophoricity|/' main.sdx
	sed -i 's/marked|/markedness|/' main.sdx
	sed -i 's/modifiers/modifier/' main.sdx
	sed -i 's/PPT/predicates of personal taste/' main.sdx
	sed -i 's/PSP|/presupposition|/' main.sdx
	sed -i 's/presuppositions/presupposition/' main.sdx
	sed -i 's/PSPs/presupposition/' main.sdx
	sed -i 's/PC/propositional content/' main.sdx
	sed -i 's/reconstruct|/reconstruction|/' main.sdx
	sed -i 's/RDs/rising declaratives/' main.sdx
	sed -i 's/RD|/rising declaratives|/' main.sdx
	sed -i 's/SAV/subjective attitude verbs/' main.sdx
	sed -i 's/unaccusative/unaccusativity/' main.sdx
	sed -i 's/IS/information structure/' main.sdx
	sed -i 's/IU/information unit/' main.sdx
	sed -i 's/conventional implicatures|/conventional implicature|/' main.sdx
	fixindex
...
README.md: 
	...
	echo '## Publication Info' >> README.mdsed -i 's/conventional implicatures/conventional implicature/' main.sdx
