...
main.snd: main.bbl
	...
	sed -i 's/ Solon//' main.ldx
	sed -i 's/ Ewenki//' main.ldx
	sed -i 's/ Ewenke//' main.ldx
	sed -i 's/ Evenki//' main.ldx
	sed -i 's/Aldan/Evenki!Aldan/' main.ldx
	sed -i 's/Aoluguya/Evenki!Aoluguya/' main.ldx
	sed -i 's/Ayan/Evenki!Ayan/' main.ldx
	sed -i 's/Barguzin/Evenki!Barguzin/' main.ldx
	sed -i 's/Baunt/Evenki!Baunt/' main.ldx
	sed -i 's/Chulman/Evenki!Chulman/' main.ldx
	sed -i 's/Chumikan/Evenki!Chumikan/' main.ldx
	sed -i 's/Ilimpeya/Evenki!Ilimpeya/' main.ldx
	sed -i 's/Khingan/Evenki!Khingan/' main.ldx
	sed -i 's/Mankovo/Evenki!Mankovo/' main.ldx
	sed -i 's/Morigele/Evenki!Morigele/' main.ldx
	sed -i 's/May/Evenki!May/' main.ldx
	sed -i 's/Nercha/Evenki!Nercha/' main.ldx
	sed -i 's/North-Baikal/Evenki!North-Baikal/' main.ldx
	sed -i 's/Podkamennyj/Evenki!Podkamennyj/' main.ldx
	sed -i 's/Sakhalin/Evenki!Sakhalin/' main.ldx
	sed -i 's/Siberian/Evenki!Siberian/' main.ldx
	sed -i 's/Sym/Evenki!Sym/' main.ldx
	sed -i 's/Tokko/Evenki!Tokko/' main.ldx
	sed -i 's/Tokma/Evenki!Tokma/' main.ldx
	sed -i 's/Tokmin/Evenki!Tokmin/' main.ldx
	sed -i 's/Tommot/Evenki!Tommot/' main.ldx
	sed -i 's/Tungir/Evenki!Tungir/' main.ldx
	sed -i 's/Uchir/Evenki!Uchir/' main.ldx
	sed -i 's/Uchur/Evenki!Uchur/' main.ldx
	sed -i 's/Upper Lena/Evenki!Upper Lena/' main.ldx
	sed -i 's/Urmi/Evenki!Urmi/' main.ldx
	sed -i 's/Vilyuy/Evenki!Vilyuy/' main.ldx
	sed -i 's/Vitim/Evenki!Vitim/' main.ldx
	sed -i 's/Yerbogachyon/Evenki!Yerbogachyon/' main.ldx
	sed -i 's/Zeya/Evenki!Zeya/' main.ldx
	sed -i 's/Tunguska/Evenki!Tunguska/' main.ldx
	sed -i 's/Tugur-Chumikan/Evenki!Tugur-Chumikan/' main.ldx
	sed -i 's/Urulga/Evenki!Urulga/' main.ldx
	sed -i 's/Urulyungui/Evenki!Urulyungui/' main.ldx
	sed -i 's/Vanavara/Evenki!Vanavara/' main.ldx
	sed -i 's/Poligus/Evenki!Poligus/' main.ldx
	sed -i 's/Aihui/Manchu!Aihui/' main.ldx
	sed -i 's/Lalin/Manchu!Lalin/' main.ldx
	sed -i 's/Sanjiazi/Manchu!Sanjiazi/' main.ldx
	sed -i 's/Yanbian/Manchu!Yanbian/' main.ldx
	sed -i 's/Yibuqi/Manchu!Yibuqi/' main.ldx
	sed -i 's/Beryozovka/Even!Beryozovka/' main.ldx
	sed -i 's/Bystraja/Even!Bystraja/' main.ldx
	sed -i 's/Lamunkhin/Even!Lamunkhin/' main.ldx
	sed -i 's/Tompo/Even!Tompo/' main.ldx
	sed -i 's/Standard/Even!Standard/' main.ldx
	sed -i 's/Northern Uilta/Uilta!Northern Uilta/' main.ldx
	sed -i 's/Southern Uilta/Uilta!Southern Uilta/' main.ldx
	sed -i 's/Xor/Udihe!Xor/' main.ldx
	sed -i 's/Kur-/Udihe!Kur-/' main.ldx
	sed -i 's/Anjuj/Udihe!Anjuj/' main.ldx
	sed -i 's/Xungari/Udihe!Xungari/' main.ldx
	sed -i 's/Iman/Udihe!Iman/' main.ldx
	sed -i 's/Bikin/Udihe!Bikin/' main.ldx
	sed -i 's/Samarga/Udihe!Samarga/' main.ldx
	sed -i 's/Lower Negidal/Negidal!Lower Negidal/' main.ldx
	sed -i 's/Upper Negidal/Negidal!Upper Negidal/' main.ldx
	sed -i 's/Koppi/Oroch!Koppi/' main.ldx
	sed -i 's/Xadi/Oroch!Xadi/' main.ldx
	sed -i 's/Tumnin/Oroch!Tumnin/' main.ldx
	sed -i 's/Gankui/Oroqen!Gankui/' main.ldx
	sed -i 's/Nanmu/Oroqen!Nanmu/' main.ldx
	sed -i 's/Shengli/Oroqen!Shengli/' main.ldx
	sed -i 's/Xunke/Oroqen!Xunke/' main.ldx
	sed -i 's/Ussuri/Nanai!Ussuri/' main.ldx
	sed -i 's/Arong/Solon!Arong/' main.ldx
	sed -i 's/Hailar/Solon!Hailar/' main.ldx
	sed -i 's/Huihe/Solon!Huihe/' main.ldx
	sed -i 's/Nonni/Solon!Nonni/' main.ldx
	sed -i 's/Ongkor/Solon!Ongkor/' main.ldx
	python3 fixindex.py al
