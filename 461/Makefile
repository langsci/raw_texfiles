...
main.snd: main.bbl
	...
	sed -i 's/textit/emph/' main.wdx
	sed -i 's/\nobreakdash -/-/' main.wdx
	sed -i 's/Abraham./Abraham!/' main.wdx
	sed -i 's/Aristophanes/Aristophanes!/' main.wdx
	sed -i 's/Aristoteles/Aristotle/' main.wdx
	sed -i 's/Aristotle, /Aristotle!/' main.wdx
	sed -i 's/Plato, /Plato!/' main.wdx
	sed -i 's/Caesar, /Caesar!/' main.wdx
	sed -i 's/Cicero, /Cicero!/' main.wdx
	sed -i 's/Demosthenes, /Demosthenes!/' main.wdx
	sed -i 's/Euripides, /Euripides!/' main.wdx
	sed -i 's/Herodotus, /Herodotus!/' main.wdx
	sed -i 's/Hesiod, /Hesiod!/' main.wdx
	sed -i 's/Homer, /Homer!/' main.wdx
	sed -i 's/Isocrates, /Isocrates!/' main.wdx
	sed -i 's/Livy, /Livy!/' main.wdx
	sed -i 's/Lysias, /Lysias!/' main.wdx
	sed -i 's/Plautus, /Plautus!/' main.wdx
	sed -i 's/Quintilian, /Quintilian!/' main.wdx
	sed -i 's/R̥gveda (RV) /R̥gveda!/' main.wdx
	sed -i 's/Xenophon, /Xenophon!/' main.wdx
	sed -i 's/Strabo, /Strabo!/' main.wdx
	sed -i 's/Terence, /Terence!/' main.wdx
	sed -i 's/Thucydides, /Thucydides!/' main.wdx
	sed -i 's/Yasna (Y) /Yasna!/' main.wdx
	sed -i 's/Yašt (Yt) /Yašt /' main.wdx
	sed -i 's/HC /HC!/' main.wdx
	sed -i 's/NT 1 /NT /' main.wdx
	sed -i 's/NT 2 /NT /' main.wdx
	sed -i 's/NT 3 /NT /' main.wdx
	sed -i 's/OT 1 /OT /' main.wdx
	sed -i 's/OT 2 /OT /' main.wdx
	sed -i 's/OT 3 /OT /' main.wdx
	sed -i 's/OT 4 /OT /' main.wdx
	sed -i 's/NT /NT!/' main.wdx
	sed -i 's/NT /NT!/' main.wdx
	sed -i 's/NT /NT!/' main.wdx
	sed -i 's/NT /NT!/' main.wdx
	sed -i 's/OT /OT!/' main.wdx
	sed -i 's/!, /!/' main.wdx
	fixindex
