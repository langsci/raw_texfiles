...
main.snd: main.bbl
	...
	sed -i s/.*ssociation*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*IPA*// main.adx #remove titles which biblatex puts into the name index
