...
main.snd: main.bbl
	...
	sed -i 's/.*Historia.*//' main.adx
	sed -i 's/.*Instituto.*//' main.adx
	sed -i 's/.*República.*//' main.adx
	sed -i 's/.*UNESCO.*//' main.adx
	sed -i 's/.*INEGI.*//' main.adx
	sed -i 's/.*Group.*//' main.adx
	sed -i 's/.*Comunidad.*//' main.adx
	sed -i 's/.*Congreso.*//' main.adx
	sed -i 's/.*Estadística.*//' main.adx
	sed -i 's/.*nacional.*//' main.adx
	sed -i 's/.*Mapuche.*//' main.adx
