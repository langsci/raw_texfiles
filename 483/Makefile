...
main.snd: main.bbl
	...
	sed -i 's/.*League.*//' main.adx
	sed -i 's/.*Bulletin.*//' main.adx
	sed -i 's/.*Conseil.*//' main.adx
	sed -i 's/.*Courrier.*//' main.adx
	sed -i 's/.*Enterprise.*//' main.adx
	sed -i 's/.*Highlands.*//' main.adx
	sed -i 's/.*Tahiti.*//' main.adx
	sed -i 's/.*National.*//' main.adx
	sed -i 's/.*Le Monde.*//' main.adx
	sed -i 's/.*Center.*//' main.adx
