...
\newenvironment{styleListParagraph}{\renewcommand\baselinestretch{1.25}\setlength\leftskip{0.5in}\setlength\rightskip{0in}\setlength\parindent{0in}\setlength\parfillskip{0pt plus 1fil}\setlength\parskip{0in plus 1pt}\writerlistparindent\writerlistleftskip\leavevmode\normalfont\normalsize\writerlistlabel\ignorespaces}{\unskip\vspace{0in plus 1pt}\par}
\newenvironment{stylecaption}{\renewcommand\baselinestretch{1.0}\setlength\leftskip{0in plus 1fil}\setlength\rightskip{0in plus 1fil}\setlength\parindent{0in}\setlength\parfillskip{0pt}\setlength\parskip{0in plus 1pt}\writerlistparindent\writerlistleftskip\leavevmode\normalfont\normalsize\fontsize{11pt}{13.2pt}\selectfont\bfseries\writerlistlabel\ignorespaces}{\unskip\vspace{0.139in plus 0.0139in}\par}
...
\newcommand\labellistWWNumileveli{[F076?]}
\newcommand\labellistWWNumilevelii{\textstyleListLabeli{o}}
\newcommand\labellistWWNumileveliii{[F0A7?]}
\newcommand\labellistWWNumileveliv{[F0B7?]}
\newenvironment{listWWNumileveli}{\def\writerlistleftskip{\setlength\leftskip{0.6972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumileveli}\hspace{-1.135888cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumilevelii}{\def\writerlistleftskip{\setlength\leftskip{1.1972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumilevelii}\hspace{-2.4058878cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumileveliii}{\def\writerlistleftskip{\setlength\leftskip{1.6972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumileveliii}\hspace{-3.675888cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumileveliv}{\def\writerlistleftskip{\setlength\leftskip{2.1972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumileveliv}\hspace{-4.945888cm}\writerlistremovelabel}}}{}
...
\newcommand\labellistWWNumxxxvleveli{(\thelistWWNumxxxvleveli)}
...
\newenvironment{listWWNumxxxvleveli}{\def\writerlistleftskip{\setlength\leftskip{0.6972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxxvleveli}\makebox[0cm][l]{\labellistWWNumxxxvleveli}\hspace{-1.135888cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxvlevelii}{\def\writerlistleftskip{\setlength\leftskip{1.1972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxxvlevelii}\makebox[0cm][l]{\labellistWWNumxxxvlevelii}\hspace{-2.4058878cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxvleveliii}{\def\writerlistleftskip{\setlength\leftskip{1.6972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.1252in}}\def\writerlistlabel{\stepcounter{listWWNumxxxvleveliii}\makebox[0cm][r]{\labellistWWNumxxxvleveliii}\hspace{-3.99288cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxvleveliv}{\def\writerlistleftskip{\setlength\leftskip{2.1972in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\stepcounter{listWWNumxxxvleveliv}\makebox[0cm][l]{\labellistWWNumxxxvleveliv}\hspace{-4.945888cm}\writerlistremovelabel}}}{}
...
\newcommand\labellistWWNumxxxivleveli{\textstyleListLabelix{{}-}}
\newcommand\labellistWWNumxxxivlevelii{\textstyleListLabelx{o}}
\newcommand\labellistWWNumxxxivleveliii{[F0A7?]}
\newcommand\labellistWWNumxxxivleveliv{[F0B7?]}
\newenvironment{listWWNumxxxivleveli}{\def\writerlistleftskip{\setlength\leftskip{0.5in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumxxxivleveli}\hspace{-0.635cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxivlevelii}{\def\writerlistleftskip{\setlength\leftskip{1in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumxxxivlevelii}\hspace{-1.905cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxivleveliii}{\def\writerlistleftskip{\setlength\leftskip{1.5in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumxxxivleveliii}\hspace{-3.175cm}\writerlistremovelabel}}}{}
\newenvironment{listWWNumxxxivleveliv}{\def\writerlistleftskip{\setlength\leftskip{2in}}\def\writerlistparindent{}\def\writerlistlabel{}\def\item{\def\writerlistparindent{\setlength\parindent{-0.25in}}\def\writerlistlabel{\makebox[0cm][l]{\labellistWWNumxxxivleveliv}\hspace{-4.4449997cm}\writerlistremovelabel}}}{}
