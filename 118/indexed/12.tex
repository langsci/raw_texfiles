...
\item Relative clause. Relative clauses are clauses embedded in a noun phrase within the matrix clause. These are discussed in \sectref{sec:5.4.3}.
\item A clause linked to another clause by a conjunction (\sectref{sec:12.3}). 
\item A clause marked with \textit{na} or other expectation marker. The \textit{na}{}-marked clause contains known or presupposed information. This construction is discussed in \sectref{sec:11.1}. 
\item Juxtaposition of two independent clauses (\sectref{sec:12.4}).
\end{itemize}
...
The complement clause is embedded in the verb phrase as a subject, direct object, or indirect object within the matrix clause.  Nominalised and dependent verb forms collocate with constructions that carry different modal/aspectual\is{Tense, mood, and aspect!Aspect in complement clauses} values. The nominalised form collocates %%\is{Tense, mood, and aspect!Completion} 
with constructions that carry a finished, accomplished idea or imply a state,\footnote{The situation refers to something that occurred in the past with ongoing effects to the point of reference.} e.g., \textit{ndav} ‘finish,’ (\ref{ex:12:1}, see \sectref{sec:7.6}). In contrast, the dependent form is found in constructions that have an incomplete or unachieved idea at the time of the matrix situation, e.g., the verb of inception %%\is{Tense, mood, and aspect!Inception}
\textit{zlan} ‘begin’ (\ref{ex:12:7}, see \sectref{sec:7.7}). When the subject of the complement clause is the same as the subject of the matrix clause, it is indicated by Ø in the examples. The clauses are delimited by square brackets and the verb is bolded.
...
A clause with the nominalised form can function as an argument of another verb. It is the subject in \REF{ex:12:2} and the direct object in (\ref{ex:12:3}--\ref{ex:12:6}). In each case, the nominalised form gives a completed idea to the action on the verb.
...
\gll  {}[a-s=aw [Ø  \textbf{amɪ-pɛɗ{}-}ɛ ʃɛʃɛ]]\\
      \oldstylenums{3}\textsc{s}-want={\oneS}.{\IO} {} {\DEP}-crunch-{\CL}  meat\\
...
\gll  {}[a-\textbf{s}=aw  [Ø \textbf{amɪ-g-ijɛ}    {ambɛlɛ mbɛlɛ}  nə  mɔkʷtɔnɔkʷ]]\\
      \oldstylenums{3}\textsc{s}-want={\oneS}.{\IO}  {}  {\DEP}-do-{\CL}  race    with  toad\\
...
Finite complement clauses are used with verbs that express propositional attitude, with verbs of speech, and with verbs of desire. The complement clause is the direct object of verbs of these propositional attitude  (‘know,’ \REF{ex:12:14},\footnote{Note that in this example, the complement clause and the \DO pronoun \textit{na} in the matrix clause are co-referential.} ‘think,’ \REF{ex:12:15}, ‘believe,’ \REF{ex:12:16}, ‘doubt,’ \REF{ex:12:17}, ‘forget,’ \REF{ex:12:18}, or ‘worry,’ \REF{ex:12:19}). In the examples, the clauses are delimited by square brackets and the verb is bolded.


\ea \label{ex:12:14}
{}[Nasar  na  va,  [bahay  \textbf{apaɗəva}  sese.]] \\
\gll  {}[na-sar na   =va   [bahaj   \textbf{à-paɗ-ə}    \textbf{=va}   ʃɛʃɛ]]\\
      {\oneS}-know  {\DO}  ={\PRF}  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL}  ={\PRF}  meat\\
...
\gll  {}[nə-ɗəgal-aj   na   [bahaj   \textbf{à-paɗ-ə} \textbf{=va}   ʃɛʃɛ]]\\
      {\oneS}-think{}-{\CL}  {\PSP}  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL}  ={\PRF}  meat\\
...
\gll  {}[na-faɗ   na   [bahaj   \textbf{à-paɗ-ə} \textbf{=va}    ʃɛʃɛ]]\\
      {\oneS}-place  {\PSP}  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL}  ={\PRF}  meat\\
...
\gll  {}[nə-kaɗ   waja   na   [bahaj   \textbf{à-paɗ-ə} \textbf{=va}  ʃɛʃɛ]]\\
      {\oneS}-kill because {\PSP} chief \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL} ={\PRF}  meat\\
...
\gll  {}[a-tʃəkəɮ=aw   a  har  ava  [bahaj   \textbf{à-paɗ-ə} \textbf{=va} ʃɛʃɛ]]\\
      \oldstylenums{3}\textsc{s}-forget={\oneS}.{\IO}  at  body  in  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL}  ={\PRF}  meat\\
...
\gll  {}[na-ɮaw-aj   na   [bahaj   \textbf{à-paɗ-ə} \textbf{=va} ʃɛʃɛ]]\\
      {\oneS}-fear{}-{\CL}  {\PSP}  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL}  ={\PRF}  meat\\
...
\gll  [nɛ  awij   [bahaj  \textbf{à-paɗ-ə} \textbf{=va}  ʃɛʃɛ]]\\
      {\oneS}  said  chief  \oldstylenums{3}\textsc{s}+{\PFV}-crunch-{\CL} ={\PRF}  meat\\
...
\gll  {}[[ndahaŋ  \textbf{amɪ-tʃɛŋ} mɪ-bɛl-ɛ    a  mbʊkʷɔ  =ahaj  dɪrɛffɛfɛ    na]\\  
 \hspaceThis{[[}\oldstylenums{3}\textsc{s} {\DEP}-hear  {\NOM}{}-move-{\CL}  {\GEN}  \ili{Mbuko}  =Pl  \textsc{id}movement  {\PSP}\\  
 \glt ‘He, hearing the movement of the \ili{Mbuko} (lit. he to hear moving of Mbukos \textit{dəreffefe}),’\\
...
\gll  Hʊrmbʊlɔm á-g-a ɓərav =va kuwaja war dalaj na\\ 
     God \oldstylenums{3}\textsc{s}+{\IFV}-do-{\CL} heart ={\PRF} {because of} child girl {\PSP}\\
...
\gll  ɮɛɮɛ na Mʊlɔkʷɔ =ahaj na Hʊrmbʊlɔm á-vəl=ata barka\\ 
     {long ago} {\PSP} Moloko =Pl  {\PSP} God \oldstylenums{3}\textsc{s}+{\IFV}-send=\oldstylenums{3}\textsc{s}.{\IO}   blessing\\   
...
\gll  Hʊrmbʊlɔm   á-g-a  ɓərav     =va \\   
      God    \oldstylenums{3}\textsc{s}+{\IFV}-do-{\CL}    heart   ={\PRF} \\
...
The clause introduced by \textit{ha} ‘until’ expresses a literal or metaphorical boundary that marks the termination or cessation of the activity or situation expressed by the matrix clause (\ref{ex:12:40},\footnote{From the Race story, \citealt{Friesen2003}.} \ref{ex:12:41}).
...
\gll  {}[\textbf{asa} á-s=ɔkʷ       nʒuwɛlɛk  na]  ká-ndaɗ-aj  ɛlɛlɛ  kɪlɛŋ\\
      if  \oldstylenums{3}\textsc{s}+{\IFV}-cut={\twoS}.{\IO}  {leaf (spp.)}  {\PSP}  {\twoS}+{\IFV}-like{}-{\CL}  sauce  then\\
...
\gll kʷɔ mɪ-bɛl-ɛ nɛkʷɛŋ ɗuw nɔ-bʊl-ɔm baj]\\
     even  {\NOM}{}-move-{\CL}  little  also  \oldstylenums{1}-move-\oldstylenums{1}\textsc{Pex}  {\NEG}\\
...
\textit{Kəlen} ‘next’ indicates a subsequent mainline event that often follows a digression (often reported speech). This conjunction can either be clause-initial \REF{ex:12:57} or it may follow the first argument in the clause \REF{ex:12:56}.  
...
Clauses S. 7 and 8 are shown in \REF{ex:12:57}, where \textit{kəlen} coordinates the clause in S. 8 to the eventline after the speech in S. 7.
...
\REF{ex:12:65} is from S. 8--10 in the peak episode of the Snake story\is{Focus and prominence!Discourse peak}. There is a series of three juxtaposed independent clauses. The second is a restatement of the first. The third follows chronologically. 
...
Two juxtaposed clauses can express a logical or chronological sequence. \REF{ex:12:66} illustrates a temporal (or logical) sequence from the Cicada fable. The two clauses are the chief’s command to bring the tree to his door. First (clause 1), the people are to bring the tree and next (clause 2), they are to place it by his door. 
...
Two clauses linked by juxtaposition can also express a comparison (\ref{ex:12:68} and \ref{ex:12:69}). The first clause is a predicate-adjective clause (see \sectref{sec:10.1.2}) that expresses the attribute being compared. The second clause establishes the comparison by means of the verb \textit{dal} ‘pass.’
