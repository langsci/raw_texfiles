...
\gll  {}[ta-nd=alaj    ta-l =ala  tə-ɮəg-ə   {\textbf{va}}  \ulp{ana}{~~~~~~}  \ulp{Mʊlɔkʷɔ}{~~~~~}    \ule{=ahaj}]\\
...
\gll  {}[ɛ-ndʒ{}-ɛ    \ulp{kə}{~~~}  \ulp{dɛlmɛtɛ}{~~~~}  \ule{aka} \ulp{a}{~~~}  \ulp{ɬam}{~~~~}  \ule{ɛnɛŋ}]\\
...
Some temporal adverbs can occur first in the clause or last in the verb phrase (\ref{ex:8:7} and \ref{ex:8:8}), but not in the interior of the verb phrase. Likewise, emphatic interrogative pronouns occur first or last in the clause (emphatic interrogative pronouns are bolded in \ref{ex:8:9}, see \sectref{sec:10.3.5}). 
...
\gll  ndahaŋ  [\textit{gʊdɔkʷ}     mɪ-d-ijɛ       gʊzɔm ]\\
      \oldstylenums{3}\textsc{s}        {\textsc{id}prepare wine}  {\NOM}{}-prepare-{\CL}   wine\\
...
\gll  {}[\textbf{nɔ-ndɔj}  nɔ-mbɔs-ɔm   va]\\
      \oneP-{\PRG}    \oneP-rest-\oldstylenums{1}\textsc{pex}  body\\
\glt  ‘We are resting.’ 
\z
...
\gll  {}[\textbf{nɔ-ndɔj}     nɔ-dɔr-ɔm amsɔkʷɔ]\\
      \oneP-{\PRG}    \oneP-plant-\oldstylenums{1}\textsc{Pex}  {dry season millet}\\
...
In discourse, progressive aspect is used to mark an event that is in progress in a Moloko text. It is not necessarily in the background, but indicates durative or ongoing dynamic events. In the Cicada setting, sentences S.~3--5 \REF{ex:8:28}, there is a progressive in a tail-head link (see \sectref{sec:11.1.3}) showing what the young men were doing when they found the tree. 
...
\gll  hʷɔr gʷɔlɔ afa lɪmɛ na mɪ-nʒ-ijɛ =alɪmɛ na kijga\\ 
      woman  \textsc{honour}   {at place}   \oldstylenums{1}\textsc{Pex}   {\PSP} {\NOM}{}-sit-{\CL} =\oldstylenums{1}\textsc{Pex}.{\POSS}  {\PSP}   {like this} \\ 
...
\gll  Hʊrmbʊlɔm \textbf{a-ndaj}  á-sak    =alɪmɛ na aka\\
      God            \oldstylenums{3}\textsc{s}-{\PROG}   \oldstylenums{3}\textsc{s}+{\IFV}-multiply =\oldstylenums{2}\textsc{Pex}.{\IO}   \oldstylenums{3}\textsc{s}.{\DO}   on\\
\glt  ‘God is multiplying it for us.”’
\z

Progressives are also found in the peak section\is{Focus and prominence!Discourse peak} of a narrative where they function to slow down the events and draw the reader into the action. \REF{ex:8:30} shows the entire peak section of the Disobedient Girl. In the story (shown in its entirety in \sectref{sec:1.5}), there is a battle between the disobedient girl and the millet itself. The millet has a supernatural ability to expand, and eventually triumphs over the girl. Verbs in the progressive form (bolded in the example) mark the ongoing multiplication of the millet (S. 23) while the girl is grinding as well as the girl’s ongoing grinding (S. 25) while the room is filling up with flour. 
...
\gll  nata ndahaŋ dʊɓʊsɔlʊk mə-mət=ava=alaj a hʷɔɗ a haj\\ 
      {and then}  \oldstylenums{3}\textsc{s}   {\textsc{id}collapse/die}  {\NOM}-die=in=away   at  stomach {\GEN}   house\\  
\medskip     
\gll na ava\\
    {\PSP}   in\\ 
...
\gll  ndahaŋ  [\textbf{ŋg-aj}       ma-ŋg           =aka=alaj    pʊrgʷɔm\\  
      \oldstylenums{3}\textsc{s}    {make with grass}-{\CL}  {{\NOM}{}-make with grass} =on=away    trap\\   
...
\medskip
[\textbf{dək} mədəkan  na  mənjəye  ata.] \\
