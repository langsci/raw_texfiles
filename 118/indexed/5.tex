...
A noun modified by a numeral (\ref{ex:5:11}--\ref{ex:5:12}, \sectref{sec:3.3}).
...
A noun modified by a derived adjective (\ref{ex:5:13}--\ref{ex:5:14}, \sectref{sec:5.3}).
...
A noun modified by a demonstrative (\ref{ex:5:15}--\ref{ex:5:16},  \sectref{sec:3.2}).
...
\gll  lɪmɛ    Mʊlɔkʷɔ  =ahaj    na   n\`{ə}-mbʊɗ{}-ɔm        a  dəraj  ava  na \\
      \oldstylenums{1}\textsc{Pex}   Moloko      =Pl  {\PSP}  \oldstylenums{1}+{\PFV}-change-\oldstylenums{1}\textsc{Pex}  at   head  in    {\PSP}\\
...
\gll  {}[dəraj  \textbf{ga}]  aŋga  lɪmɛ    [mɪtɛnɛŋ     \textbf{ga}]    aŋga  mbɔkʷɔ   =ahaj\\
      head  {\ADJ}  {\POSS}  \oldstylenums{1}\textsc{Pex}    hindparts  {\ADJ}    {\POSS}  \ili{Mbuko}  =Pl\\
\glt  ‘The head [is] ours; the hindparts [are] the \ili{Mbuko}'s.’ 
\z
...
\gll  n\`{ə}-bɔh-ɔm      ta    =alaj  lɪmɛ  [ɮɔm   \textbf{ga}]\\
      \oldstylenums{1}\textsc{Pex}+{\PFV}-pour-\oldstylenums{1}\textsc{Pex}  \oldstylenums{3}\textsc{p}.{\DO} =away  \oldstylenums{1}\textsc{Pex}   five  {\ADJ}\\
...
\gll  ʃɛŋ     a   ɬam   na  ava   nɛndɪgɛ  na  n\`{ə}-mʊnzɔr-ɔm    [ma     \textbf{ga}]\\
 \textsc{id}walk  at  place   {\PSP}  in   {\DEM}   {\PSP}   \oldstylenums{1}\textsc{Pex}+{\PFV}-see-\oldstylenums{1}\textsc{Pex}   word   {\ADJ}\\
...
\gll  n\`{ə}-bɔh-ɔm      [ma  \textbf{ga}]  a  brijgad  ava\\
      \oldstylenums{1}\textsc{Pex}+{\PFV}-pour-\oldstylenums{1}\textsc{Pex}    word  {\ADJ}   at   Brigade  in\\
...
\gll waja ama-z =ata =ala ɗaf ana [mɪʒɛ ɛnɛŋ =ahaj\\
      because  {\DEP}-take =\oldstylenums{3}\textsc{p}.{\IO}  =to  {millet loaf}  {\DAT} person  another  =Pl\\
...
\textbf{ləme} \textbf{aməngele  alay  sla  ahay  jəyga  na}.]\\
 \gll \textbf{lɪmɛ} \textbf{amɪ{}-ŋgɛl-ɛ} \textbf{=alaj} \textbf{ɬa} \textbf{=ahaj} \textbf{dʒijga} \textbf{na}]\\
      \oldstylenums{1}\textsc{Pex}  {\DEP}-return-{\CL}  =away  cow  =Pl  all  {\PSP}\\
\glt  ‘that drove the cows [to Tokembere].’ (lit. we the ones returning all cows) 
\z

In all of the above examples, the head noun can be modified by other modifiers in addition to the relative clause. Sometimes, however, the relative clause itself is the entire noun phrase (\ref{ex:5:107}--\ref{ex:5:108}). These noun phrases that consist of relative clauses take no other noun phrase modifiers. Also, they are apparently limited in the type of clause construction in which they can occur. They can only be the predicate of a larger predicate nominal construction (see \sectref{sec:10.1.2}). \REF{ex:5:107} and \REF{ex:5:108} are interrogative constructions with a predicate nominal structure (see \sectref{sec:10.3.1}). We found no natural examples where a headless relative clause served as a matrix component in a matrix verbal clause. \REF{ex:5:108} is an emphatic construction (see \sectref{sec:10.3.5}). 
...
\gll  à-gə  na  =va    [ɛlɛ     \textbf{nɛ} \textbf{ama-h=aŋ}   \textbf{Ø}\\
      \oldstylenums{3}\textsc{s}+{\PFV}-do     \oldstylenums{3}\textsc{s}.{\DO}   ={\PRF}   thing   {\oneS}     {\DEP}-say=\oldstylenums{3}\textsc{s}.{\IO}  { }\\
...
\gll  \textbf{amɪ-dʒ-ijɛ} {\textbar}\textbf{m\`{ɛ}-g-ɛ} \textbf{Ø} \textbf{baj}{\textbar} \textbf{na}] ɛʃɪmɛj\\
      {\DEP}-tell-{\CL}    \oldstylenums{3}\textsc{s}+{\HOR}-do-{\CL} { } {\NEG}    {\PSP}    {not so}\\
\glt  ‘she should not do, not so?’ (lit. [the thing] that [I] said she shouldn’t do, not so)
\z

Plural head nouns in noun phrases containing a relative clause have so far only been noted in elicited relative clauses and their interpretation is ambiguous. In these noun phrases, speakers insert the plural \textit{=ahay}  in one of two places: the plural \textit{=ahay} can occur immediately following the head noun, or in some instances it may follow the relative clause. \REF{ex:5:110} and \REF{ex:5:111} show the plural in front of the relative clause. 
...
When the plural \textit{=ahay}  occurs after the relative clause \REF{ex:5:113}, exactly what is pluralised is ambiguous. When plural forms are used in Moloko discourse, which possibility is correct must be already clear from the context. \REF{ex:5:112} and \REF{ex:5:113} give the singular and plural head nouns with following relative clauses. In \REF{ex:5:113}, the possibilities are chief’s house/ chief’s houses / chiefs’ house / chiefs’ houses,’ depending on if \textit{ndam}, \textit{hay}, \textit{bahay}, or all three are pluralised. 
...
\gll  n\`{ə}-mbʊɗ{}-ɔm      a  dəraj  ava  na\\
      \oldstylenums{1}+{\PFV}-change-\oldstylenums{1}\textsc{Pex}  at   head  in    {\PSP}\\
